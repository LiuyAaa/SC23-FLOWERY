...
; <label>:17                                      ; preds = %checkBb, %12
  br i1 %15, label %18, label %36, !llfi_index !43
...
; <label>:24                                      ; preds = %checkBb2, %18
  ...
  %28 = zext i8 %27 to i64, !llfi_index !51
  %29 = xor i64 %25, %28, !llfi_index !52
  %30 = and i64 %29, 255, !llfi_index !53
  %31 = getelementptr inbounds [256 x i64]* @crc_32_tab, i32 0, i64 %30, !llfi_index !54
  %32 = load i64* %31, align 8, !llfi_index !55
  %33 = load i64* %oldcrc32, align 8, !llfi_index !56
  %34 = lshr i64 %33, 8, !llfi_index !57
  %35 = xor i64 %32, %34, !llfi_index !58
  store i64 %35, i64* %oldcrc32, align 8, !llfi_index !59
  br label %12, !llfi_index !60

; <label>:36                                      ; preds = %17
  %37 = load %struct._IO_FILE** %fin, align 8, !llfi_index !61
  %38 = call i32 @ferror(%struct._IO_FILE* %37) #4, !llfi_index !62
  %39 = icmp ne i32 %38, 0, !llfi_index !63
  br i1 %39, label %40, label %43, !llfi_index !64

; <label>:40                                      ; preds = %36
  %41 = load i8** %2, align 8, !llfi_index !65
  call void @perror(i8* %41), !llfi_index !66
  %42 = load i64** %4, align 8, !llfi_index !67
  store i64 -1, i64* %42, align 8, !llfi_index !68
  br label %43, !llfi_index !69

; <label>:43                                      ; preds = %40, %36
  %44 = load %struct._IO_FILE** %fin, align 8, !llfi_index !70
  %45 = call i32 @fclose(%struct._IO_FILE* %44), !llfi_index !71
  %46 = load i64* %oldcrc32, align 8, !llfi_index !72
  %47 = xor i64 %46, -1, !llfi_index !73
  store i64 %47, i64* %oldcrc32, align 8, !llfi_index !74
  %48 = load i64** %3, align 8, !llfi_index !75
  store i64 %47, i64* %48, align 8, !llfi_index !76
  store i32 0, i32* %1, !llfi_index !77
  br label %49, !llfi_index !78

; <label>:49                                      ; preds = %43, %9
  %50 = load i32* %1, !llfi_index !79
  ret i32 %50, !llfi_index !80
}
