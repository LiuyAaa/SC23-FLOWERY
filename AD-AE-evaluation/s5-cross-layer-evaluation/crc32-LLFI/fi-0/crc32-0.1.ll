...
; <label>:17                                      ; preds = %checkBb, %12
  br i1 %15, label %18, label %33, !llfi_index !43

; <label>:18                                      ; preds = %17
  %19 = load i64** %4, align 8, !llfi_index !44
  %20 = load i64* %19, align 8, !llfi_index !45
  %21 = add nsw i64 %20, 1, !llfi_index !46
  store i64 %21, i64* %19, align 8, !llfi_index !47
  %22 = load i64* %oldcrc32, align 8, !llfi_index !48
  %23 = load i32* %c, align 4, !llfi_index !49
  %24 = trunc i32 %23 to i8, !llfi_index !50
  %25 = zext i8 %24 to i64, !llfi_index !51
  %26 = xor i64 %22, %25, !llfi_index !52
  %27 = and i64 %26, 255, !llfi_index !53
  %28 = getelementptr inbounds [256 x i64]* @crc_32_tab, i32 0, i64 %27, !llfi_index !54
  %29 = load i64* %28, align 8, !llfi_index !55
  %30 = load i64* %oldcrc32, align 8, !llfi_index !56
  %31 = lshr i64 %30, 8, !llfi_index !57
  %32 = xor i64 %29, %31, !llfi_index !58
  store i64 %32, i64* %oldcrc32, align 8, !llfi_index !59
  br label %12, !llfi_index !60

; <label>:33                                      ; preds = %17
  %34 = load %struct._IO_FILE** %fin, align 8, !llfi_index !61
  %35 = call i32 @ferror(%struct._IO_FILE* %34) #4, !llfi_index !62
  %36 = icmp ne i32 %35, 0, !llfi_index !63
  br i1 %36, label %37, label %40, !llfi_index !64

; <label>:37                                      ; preds = %33
  %38 = load i8** %2, align 8, !llfi_index !65
  call void @perror(i8* %38), !llfi_index !66
  %39 = load i64** %4, align 8, !llfi_index !67
  store i64 -1, i64* %39, align 8, !llfi_index !68
  br label %40, !llfi_index !69

; <label>:40                                      ; preds = %37, %33
  %41 = load %struct._IO_FILE** %fin, align 8, !llfi_index !70
  %42 = call i32 @fclose(%struct._IO_FILE* %41), !llfi_index !71
  %43 = load i64* %oldcrc32, align 8, !llfi_index !72
  %44 = xor i64 %43, -1, !llfi_index !73
  store i64 %44, i64* %oldcrc32, align 8, !llfi_index !74
  %45 = load i64** %3, align 8, !llfi_index !75
  store i64 %44, i64* %45, align 8, !llfi_index !76
  store i32 0, i32* %1, !llfi_index !77
  br label %46, !llfi_index !78

; <label>:46                                      ; preds = %40, %9
  %47 = load i32* %1, !llfi_index !79
  ret i32 %47, !llfi_index !80
}
