...
; <label>:17                                      ; preds = %checkBb, %12
  br i1 %15, label %18, label %42, !llfi_index !43
...
; <label>:40                                      ; preds = %checkBb8, %36
  %41 = xor i64 %34, %38, !llfi_index !58
  store i64 %41, i64* %oldcrc32, align 8, !llfi_index !59
  br label %12, !llfi_index !60

; <label>:42                                      ; preds = %17
  %43 = load %struct._IO_FILE** %fin, align 8, !llfi_index !61
  %44 = call i32 @ferror(%struct._IO_FILE* %43) #4, !llfi_index !62
  %45 = icmp ne i32 %44, 0, !llfi_index !63
  br i1 %45, label %46, label %49, !llfi_index !64

; <label>:46                                      ; preds = %42
  %47 = load i8** %2, align 8, !llfi_index !65
  call void @perror(i8* %47), !llfi_index !66
  %48 = load i64** %4, align 8, !llfi_index !67
  store i64 -1, i64* %48, align 8, !llfi_index !68
  br label %49, !llfi_index !69

; <label>:49                                      ; preds = %46, %42
  %50 = load %struct._IO_FILE** %fin, align 8, !llfi_index !70
  %51 = call i32 @fclose(%struct._IO_FILE* %50), !llfi_index !71
  %52 = load i64* %oldcrc32, align 8, !llfi_index !72
  %53 = xor i64 %52, -1, !llfi_index !73
  store i64 %53, i64* %oldcrc32, align 8, !llfi_index !74
  %54 = load i64** %3, align 8, !llfi_index !75
  store i64 %53, i64* %54, align 8, !llfi_index !76
  store i32 0, i32* %1, !llfi_index !77
  br label %55, !llfi_index !78

; <label>:55                                      ; preds = %49, %9
  %56 = load i32* %1, !llfi_index !79
  ret i32 %56, !llfi_index !80
}
