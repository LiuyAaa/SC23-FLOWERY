...
; <label>:17                                      ; preds = %checkBb, %12
  br i1 %15, label %18, label %40, !llfi_index !43
...
; <label>:36                                      ; preds = %checkBb6, %29
  ...
  %38 = lshr i64 %37, 8, !llfi_index !57
  %39 = xor i64 %34, %38, !llfi_index !58
  store i64 %39, i64* %oldcrc32, align 8, !llfi_index !59
  br label %12, !llfi_index !60

; <label>:40                                      ; preds = %17
  %41 = load %struct._IO_FILE** %fin, align 8, !llfi_index !61
  %42 = call i32 @ferror(%struct._IO_FILE* %41) #4, !llfi_index !62
  %43 = icmp ne i32 %42, 0, !llfi_index !63
  br i1 %43, label %44, label %47, !llfi_index !64

; <label>:44                                      ; preds = %40
  %45 = load i8** %2, align 8, !llfi_index !65
  call void @perror(i8* %45), !llfi_index !66
  %46 = load i64** %4, align 8, !llfi_index !67
  store i64 -1, i64* %46, align 8, !llfi_index !68
  br label %47, !llfi_index !69

; <label>:47                                      ; preds = %44, %40
  %48 = load %struct._IO_FILE** %fin, align 8, !llfi_index !70
  %49 = call i32 @fclose(%struct._IO_FILE* %48), !llfi_index !71
  %50 = load i64* %oldcrc32, align 8, !llfi_index !72
  %51 = xor i64 %50, -1, !llfi_index !73
  store i64 %51, i64* %oldcrc32, align 8, !llfi_index !74
  %52 = load i64** %3, align 8, !llfi_index !75
  store i64 %51, i64* %52, align 8, !llfi_index !76
  store i32 0, i32* %1, !llfi_index !77
  br label %53, !llfi_index !78

; <label>:53                                      ; preds = %47, %9
  %54 = load i32* %1, !llfi_index !79
  ret i32 %54, !llfi_index !80
}
