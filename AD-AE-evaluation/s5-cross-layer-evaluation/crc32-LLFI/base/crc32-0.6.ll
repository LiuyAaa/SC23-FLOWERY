...
; <label>:17                                      ; preds = %checkBb, %12
  br i1 %15, label %18, label %45, !llfi_index !43
...
; <label>:31                                      ; preds = %checkBb4, %25
  ...
  %35 = getelementptr inbounds [256 x i64]* @crc_32_tab, i32 0, i64 %34, !llfi_index !54
  %36 = load i64* %35, align 8, !llfi_index !55
  %37 = load i64* %35, align 8, !llfi_index !55
  %38 = load i64* %oldcrc32, align 8, !llfi_index !56
  %39 = load i64* %oldcrc32, align 8, !llfi_index !56
  %40 = lshr i64 %38, 8, !llfi_index !57
  %41 = lshr i64 %39, 8, !llfi_index !57
  %42 = xor i64 %36, %40, !llfi_index !58
  %43 = xor i64 %37, %41, !llfi_index !58
...
; <label>:44                                      ; preds = %checkBb6, %31
  store i64 %42, i64* %oldcrc32, align 8, !llfi_index !59
  br label %12, !llfi_index !60

; <label>:45                                      ; preds = %17
  %46 = load %struct._IO_FILE** %fin, align 8, !llfi_index !61
  %47 = call i32 @ferror(%struct._IO_FILE* %46) #4, !llfi_index !62
  %48 = icmp ne i32 %47, 0, !llfi_index !63
  br i1 %48, label %49, label %52, !llfi_index !64

; <label>:49                                      ; preds = %45
  %50 = load i8** %2, align 8, !llfi_index !65
  call void @perror(i8* %50), !llfi_index !66
  %51 = load i64** %4, align 8, !llfi_index !67
  store i64 -1, i64* %51, align 8, !llfi_index !68
  br label %52, !llfi_index !69

; <label>:52                                      ; preds = %49, %45
  %53 = load %struct._IO_FILE** %fin, align 8, !llfi_index !70
  %54 = call i32 @fclose(%struct._IO_FILE* %53), !llfi_index !71
  %55 = load i64* %oldcrc32, align 8, !llfi_index !72
  %56 = xor i64 %55, -1, !llfi_index !73
  store i64 %56, i64* %oldcrc32, align 8, !llfi_index !74
  %57 = load i64** %3, align 8, !llfi_index !75
  store i64 %56, i64* %57, align 8, !llfi_index !76
  store i32 0, i32* %1, !llfi_index !77
  br label %58, !llfi_index !78

; <label>:58                                      ; preds = %52, %9
  %59 = load i32* %1, !llfi_index !79
  ret i32 %59, !llfi_index !80
}
