...
; <label>:17                                      ; preds = %checkBb, %12
  br i1 %15, label %18, label %47, !llfi_index !43
...
; <label>:25                                      ; preds = %checkBb2, %18
  ...
  %27 = load i32* %c, align 4, !llfi_index !49
  %28 = load i32* %c, align 4, !llfi_index !49
  %29 = trunc i32 %27 to i8, !llfi_index !50
...
; <label>:31                                      ; preds = %checkBb4, %25
  %32 = zext i8 %29 to i64, !llfi_index !51
  %33 = xor i64 %26, %32, !llfi_index !52
  %34 = and i64 %33, 255, !llfi_index !53
  %35 = and i64 %33, 255, !llfi_index !53
...
; <label>:36                                      ; preds = %checkBb6, %31
  %37 = getelementptr inbounds [256 x i64]* @crc_32_tab, i32 0, i64 %34, !llfi_index !54
  %38 = load i64* %37, align 8, !llfi_index !55
  %39 = load i64* %37, align 8, !llfi_index !55
  %40 = load i64* %oldcrc32, align 8, !llfi_index !56
  %41 = load i64* %oldcrc32, align 8, !llfi_index !56
  %42 = lshr i64 %40, 8, !llfi_index !57
  %43 = lshr i64 %41, 8, !llfi_index !57
  %44 = xor i64 %38, %42, !llfi_index !58
  %45 = xor i64 %39, %43, !llfi_index !58
...
; <label>:46                                      ; preds = %checkBb8, %36
  store i64 %44, i64* %oldcrc32, align 8, !llfi_index !59
  br label %12, !llfi_index !60

; <label>:47                                      ; preds = %17
  %48 = load %struct._IO_FILE** %fin, align 8, !llfi_index !61
  %49 = call i32 @ferror(%struct._IO_FILE* %48) #4, !llfi_index !62
  %50 = icmp ne i32 %49, 0, !llfi_index !63
  br i1 %50, label %51, label %54, !llfi_index !64

; <label>:51                                      ; preds = %47
  %52 = load i8** %2, align 8, !llfi_index !65
  call void @perror(i8* %52), !llfi_index !66
  %53 = load i64** %4, align 8, !llfi_index !67
  store i64 -1, i64* %53, align 8, !llfi_index !68
  br label %54, !llfi_index !69

; <label>:54                                      ; preds = %51, %47
  %55 = load %struct._IO_FILE** %fin, align 8, !llfi_index !70
  %56 = call i32 @fclose(%struct._IO_FILE* %55), !llfi_index !71
  %57 = load i64* %oldcrc32, align 8, !llfi_index !72
  %58 = xor i64 %57, -1, !llfi_index !73
  store i64 %58, i64* %oldcrc32, align 8, !llfi_index !74
  %59 = load i64** %3, align 8, !llfi_index !75
  store i64 %58, i64* %59, align 8, !llfi_index !76
  store i32 0, i32* %1, !llfi_index !77
  br label %60, !llfi_index !78

; <label>:60                                      ; preds = %54, %9
  %61 = load i32* %1, !llfi_index !79
  ret i32 %61, !llfi_index !80
}
