...
; <label>:17                                      ; preds = %checkBb, %12
  br i1 %15, label %18, label %43, !llfi_index !43

; <label>:18                                      ; preds = %17
  %19 = load i64** %4, align 8, !llfi_index !44
  %20 = load i64* %19, align 8, !llfi_index !45
  %21 = load i64* %19, align 8, !llfi_index !45
  %22 = add nsw i64 %20, 1, !llfi_index !46
...
; <label>:24                                      ; preds = %checkBb2, %18
  store i64 %22, i64* %19, align 8, !llfi_index !47
  %25 = load i64* %oldcrc32, align 8, !llfi_index !48
  %26 = load i32* %c, align 4, !llfi_index !49
  %27 = trunc i32 %26 to i8, !llfi_index !50
  %28 = trunc i32 %26 to i8, !llfi_index !50
  %check_cmp3 = icmp eq i8 %27, %28
...
; <label>:29                                      ; preds = %checkBb4, %24
  %30 = zext i8 %27 to i64, !llfi_index !51
  %31 = xor i64 %25, %30, !llfi_index !52
  %32 = and i64 %31, 255, !llfi_index !53
  %33 = getelementptr inbounds [256 x i64]* @crc_32_tab, i32 0, i64 %32, !llfi_index !54
  %34 = load i64* %33, align 8, !llfi_index !55
  %35 = load i64* %33, align 8, !llfi_index !55
  %36 = load i64* %oldcrc32, align 8, !llfi_index !56
  %37 = load i64* %oldcrc32, align 8, !llfi_index !56
  %38 = lshr i64 %36, 8, !llfi_index !57
  %39 = lshr i64 %37, 8, !llfi_index !57
  %40 = xor i64 %34, %38, !llfi_index !58
  %41 = xor i64 %35, %39, !llfi_index !58
...
; <label>:42                                      ; preds = %checkBb6, %29
  store i64 %40, i64* %oldcrc32, align 8, !llfi_index !59
  br label %12, !llfi_index !60

; <label>:43                                      ; preds = %17
  %44 = load %struct._IO_FILE** %fin, align 8, !llfi_index !61
  %45 = call i32 @ferror(%struct._IO_FILE* %44) #4, !llfi_index !62
  %46 = icmp ne i32 %45, 0, !llfi_index !63
  br i1 %46, label %47, label %50, !llfi_index !64

; <label>:47                                      ; preds = %43
  %48 = load i8** %2, align 8, !llfi_index !65
  call void @perror(i8* %48), !llfi_index !66
  %49 = load i64** %4, align 8, !llfi_index !67
  store i64 -1, i64* %49, align 8, !llfi_index !68
  br label %50, !llfi_index !69

; <label>:50                                      ; preds = %47, %43
  %51 = load %struct._IO_FILE** %fin, align 8, !llfi_index !70
  %52 = call i32 @fclose(%struct._IO_FILE* %51), !llfi_index !71
  %53 = load i64* %oldcrc32, align 8, !llfi_index !72
  %54 = xor i64 %53, -1, !llfi_index !73
  store i64 %54, i64* %oldcrc32, align 8, !llfi_index !74
  %55 = load i64** %3, align 8, !llfi_index !75
  store i64 %54, i64* %55, align 8, !llfi_index !76
  store i32 0, i32* %1, !llfi_index !77
  br label %56, !llfi_index !78

; <label>:56                                      ; preds = %50, %9
  %57 = load i32* %1, !llfi_index !79
  ret i32 %57, !llfi_index !80
}
