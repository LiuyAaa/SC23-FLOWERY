...
; <label>:9                                       ; preds = %checkBb, %3
  br i1 %7, label %10, label %21, !llfi_index !332
...
; <label>:18                                      ; preds = %10
  ...
  %20 = add i32 %19, 1, !llfi_index !344
  store i32 %20, i32* %i, align 4, !llfi_index !345
  br label %3, !llfi_index !346

; <label>:21                                      ; preds = %9
  %22 = load i32* %rev, align 4, !llfi_index !347
  ret i32 %22, !llfi_index !348
}
...
; <label>:35                                      ; preds = %checkBb, %29
  br i1 %33, label %36, label %75, !llfi_index !451
...
; <label>:73                                      ; preds = %checkBb6, %70
  %74 = add i32 %71, 1, !llfi_index !486
  store i32 %74, i32* %i, align 4, !llfi_index !487
...
; <label>:75                                      ; preds = %35
  ...
  br label %76, !llfi_index !491

; <label>:76                                      ; preds = %266, %75
  %77 = load i32* %BlockSize, align 4, !llfi_index !492
  %78 = load i32* %1, align 4, !llfi_index !493
  %79 = icmp ule i32 %77, %78, !llfi_index !494
  br i1 %79, label %80, label %269, !llfi_index !495

; <label>:80                                      ; preds = %76
  %81 = load double* %angle_numerator, align 8, !llfi_index !496
  %82 = load i32* %BlockSize, align 4, !llfi_index !497
  %83 = uitofp i32 %82 to double, !llfi_index !498
  %84 = fdiv double %81, %83, !llfi_index !499
  store double %84, double* %delta_angle, align 8, !llfi_index !500
  %85 = load double* %delta_angle, align 8, !llfi_index !501
  %86 = fmul double -2.000000e+00, %85, !llfi_index !502
  %87 = call double @sin(double %86) #7, !llfi_index !503
  store double %87, double* %sm2, align 8, !llfi_index !504
  %88 = load double* %delta_angle, align 8, !llfi_index !505
  %89 = fsub double -0.000000e+00, %88, !llfi_index !506
  %90 = call double @sin(double %89) #7, !llfi_index !507
  store double %90, double* %sm1, align 8, !llfi_index !508
  %91 = load double* %delta_angle, align 8, !llfi_index !509
  %92 = fmul double -2.000000e+00, %91, !llfi_index !510
  %93 = call double @cos(double %92) #7, !llfi_index !511
  store double %93, double* %cm2, align 8, !llfi_index !512
  %94 = load double* %delta_angle, align 8, !llfi_index !513
  %95 = fsub double -0.000000e+00, %94, !llfi_index !514
  %96 = call double @cos(double %95) #7, !llfi_index !515
  store double %96, double* %cm1, align 8, !llfi_index !516
  %97 = load double* %cm1, align 8, !llfi_index !517
  %98 = fmul double 2.000000e+00, %97, !llfi_index !518
  store double %98, double* %w, align 8, !llfi_index !519
  store i32 0, i32* %i, align 4, !llfi_index !520
  br label %99, !llfi_index !521

; <label>:99                                      ; preds = %260, %80
  %100 = load i32* %i, align 4, !llfi_index !522
  %101 = load i32* %i, align 4, !llfi_index !522
  %102 = load i32* %1, align 4, !llfi_index !523
  %103 = icmp ult i32 %100, %102, !llfi_index !524
  %104 = icmp ult i32 %101, %102, !llfi_index !524
...
; <label>:105                                     ; preds = %checkBb8, %99
  br i1 %103, label %106, label %264, !llfi_index !525
...
; <label>:116                                     ; preds = %254, %106
  %117 = load i32* %n, align 4, !llfi_index !542
  %118 = load i32* %n, align 4, !llfi_index !542
  %119 = load i32* %BlockEnd, align 4, !llfi_index !543
  %120 = icmp ult i32 %117, %119, !llfi_index !544
  %121 = icmp ult i32 %118, %119, !llfi_index !544
  %check_cmp9 = icmp eq i1 %120, %121
...
; <label>:122                                     ; preds = %checkBb10, %116
  br i1 %120, label %123, label %259, !llfi_index !545

; <label>:123                                     ; preds = %122
  %124 = load double* %w, align 8, !llfi_index !546
  %125 = getelementptr inbounds [3 x double]* %ar, i32 0, i64 1, !llfi_index !547
  %126 = load double* %125, align 8, !llfi_index !548
  %127 = fmul double %124, %126, !llfi_index !549
  %128 = getelementptr inbounds [3 x double]* %ar, i32 0, i64 2, !llfi_index !550
  %129 = load double* %128, align 8, !llfi_index !551
  %130 = load double* %128, align 8, !llfi_index !551
  %check_cmp11 = fcmp ueq double %129, %130
...
; <label>:131                                     ; preds = %checkBb12, %123
  %132 = fsub double %127, %129, !llfi_index !552
  %133 = getelementptr inbounds [3 x double]* %ar, i32 0, i64 0, !llfi_index !553
  store double %132, double* %133, align 8, !llfi_index !554
  %134 = getelementptr inbounds [3 x double]* %ar, i32 0, i64 1, !llfi_index !555
  %135 = load double* %134, align 8, !llfi_index !556
  %136 = getelementptr inbounds [3 x double]* %ar, i32 0, i64 2, !llfi_index !557
  store double %135, double* %136, align 8, !llfi_index !558
  %137 = getelementptr inbounds [3 x double]* %ar, i32 0, i64 0, !llfi_index !559
  %138 = load double* %137, align 8, !llfi_index !560
  %139 = getelementptr inbounds [3 x double]* %ar, i32 0, i64 1, !llfi_index !561
  store double %138, double* %139, align 8, !llfi_index !562
  %140 = load double* %w, align 8, !llfi_index !563
  %141 = getelementptr inbounds [3 x double]* %ai, i32 0, i64 1, !llfi_index !564
  %142 = load double* %141, align 8, !llfi_index !565
  %143 = fmul double %140, %142, !llfi_index !566
  %144 = getelementptr inbounds [3 x double]* %ai, i32 0, i64 2, !llfi_index !567
  %145 = load double* %144, align 8, !llfi_index !568
  %146 = fsub double %143, %145, !llfi_index !569
  %147 = getelementptr inbounds [3 x double]* %ai, i32 0, i64 0, !llfi_index !570
  store double %146, double* %147, align 8, !llfi_index !571
  %148 = getelementptr inbounds [3 x double]* %ai, i32 0, i64 1, !llfi_index !572
  %149 = load double* %148, align 8, !llfi_index !573
  %150 = getelementptr inbounds [3 x double]* %ai, i32 0, i64 2, !llfi_index !574
  store double %149, double* %150, align 8, !llfi_index !575
  %151 = getelementptr inbounds [3 x double]* %ai, i32 0, i64 0, !llfi_index !576
  %152 = load double* %151, align 8, !llfi_index !577
  %153 = getelementptr inbounds [3 x double]* %ai, i32 0, i64 1, !llfi_index !578
  store double %152, double* %153, align 8, !llfi_index !579
  %154 = load i32* %j, align 4, !llfi_index !580
  %155 = load i32* %BlockEnd, align 4, !llfi_index !581
  %156 = add i32 %154, %155, !llfi_index !582
  store i32 %156, i32* %k, align 4, !llfi_index !583
  %157 = getelementptr inbounds [3 x double]* %ar, i32 0, i64 0, !llfi_index !584
  %158 = load double* %157, align 8, !llfi_index !585
  %159 = load i32* %k, align 4, !llfi_index !586
  %160 = zext i32 %159 to i64, !llfi_index !587
  %161 = load float** %5, align 8, !llfi_index !588
  %162 = getelementptr inbounds float* %161, i64 %160, !llfi_index !589
  %163 = load float* %162, align 4, !llfi_index !590
  %164 = fpext float %163 to double, !llfi_index !591
  %165 = fpext float %163 to double, !llfi_index !591
  %166 = fmul double %158, %164, !llfi_index !592
  %167 = fmul double %158, %165, !llfi_index !592
  %168 = getelementptr inbounds [3 x double]* %ai, i32 0, i64 0, !llfi_index !593
  %169 = load double* %168, align 8, !llfi_index !594
  %170 = load i32* %k, align 4, !llfi_index !595
  %171 = zext i32 %170 to i64, !llfi_index !596
  %172 = load float** %6, align 8, !llfi_index !597
  %173 = getelementptr inbounds float* %172, i64 %171, !llfi_index !598
  %174 = load float* %173, align 4, !llfi_index !599
  %175 = fpext float %174 to double, !llfi_index !600
  %176 = fmul double %169, %175, !llfi_index !601
  %177 = fsub double %166, %176, !llfi_index !602
  %178 = fsub double %167, %176, !llfi_index !602
...
; <label>:179                                     ; preds = %checkBb14, %131
  store double %177, double* %tr, align 8, !llfi_index !603
  %180 = getelementptr inbounds [3 x double]* %ar, i32 0, i64 0, !llfi_index !604
  %181 = load double* %180, align 8, !llfi_index !605
  %182 = load i32* %k, align 4, !llfi_index !606
  %183 = zext i32 %182 to i64, !llfi_index !607
  %184 = load float** %6, align 8, !llfi_index !608
  %185 = getelementptr inbounds float* %184, i64 %183, !llfi_index !609
  %186 = load float* %185, align 4, !llfi_index !610
  %187 = fpext float %186 to double, !llfi_index !611
  %188 = fmul double %181, %187, !llfi_index !612
  %189 = getelementptr inbounds [3 x double]* %ai, i32 0, i64 0, !llfi_index !613
  %190 = load double* %189, align 8, !llfi_index !614
  %191 = load i32* %k, align 4, !llfi_index !615
  %192 = zext i32 %191 to i64, !llfi_index !616
  %193 = load float** %5, align 8, !llfi_index !617
  %194 = getelementptr inbounds float* %193, i64 %192, !llfi_index !618
  %195 = load float* %194, align 4, !llfi_index !619
  %196 = fpext float %195 to double, !llfi_index !620
  %197 = fmul double %190, %196, !llfi_index !621
  %198 = fadd double %188, %197, !llfi_index !622
  store double %198, double* %ti, align 8, !llfi_index !623
  %199 = load i32* %j, align 4, !llfi_index !624
  %200 = zext i32 %199 to i64, !llfi_index !625
  %201 = load float** %5, align 8, !llfi_index !626
  %202 = getelementptr inbounds float* %201, i64 %200, !llfi_index !627
  %203 = load float* %202, align 4, !llfi_index !628
  %204 = load float* %202, align 4, !llfi_index !628
  %205 = fpext float %203 to double, !llfi_index !629
  %206 = fpext float %204 to double, !llfi_index !629
  %207 = load double* %tr, align 8, !llfi_index !630
  %208 = load double* %tr, align 8, !llfi_index !630
  %209 = fsub double %205, %207, !llfi_index !631
  %210 = fsub double %206, %208, !llfi_index !631
  %211 = fptrunc double %209 to float, !llfi_index !632
  %212 = fptrunc double %210 to float, !llfi_index !632
  %check_cmp15 = fcmp ueq float %211, %212
  br i1 %check_cmp15, label %213, label %checkBb16

checkBb16:                                        ; preds = %179
  call void @check_flag()
  br label %213

; <label>:213                                     ; preds = %checkBb16, %179
  %214 = load i32* %k, align 4, !llfi_index !633
  %215 = zext i32 %214 to i64, !llfi_index !634
  %216 = load float** %5, align 8, !llfi_index !635
  %217 = getelementptr inbounds float* %216, i64 %215, !llfi_index !636
  store float %211, float* %217, align 4, !llfi_index !637
  %218 = load i32* %j, align 4, !llfi_index !638
  %219 = zext i32 %218 to i64, !llfi_index !639
  %220 = load float** %6, align 8, !llfi_index !640
  %221 = getelementptr inbounds float* %220, i64 %219, !llfi_index !641
  %222 = load float* %221, align 4, !llfi_index !642
  %223 = fpext float %222 to double, !llfi_index !643
  %224 = load double* %ti, align 8, !llfi_index !644
  %225 = fsub double %223, %224, !llfi_index !645
  %226 = fptrunc double %225 to float, !llfi_index !646
  %227 = load i32* %k, align 4, !llfi_index !647
  %228 = zext i32 %227 to i64, !llfi_index !648
  %229 = load float** %6, align 8, !llfi_index !649
  %230 = getelementptr inbounds float* %229, i64 %228, !llfi_index !650
  store float %226, float* %230, align 4, !llfi_index !651
  %231 = load double* %tr, align 8, !llfi_index !652
  %232 = load i32* %j, align 4, !llfi_index !653
  %233 = zext i32 %232 to i64, !llfi_index !654
  %234 = load float** %5, align 8, !llfi_index !655
  %235 = getelementptr inbounds float* %234, i64 %233, !llfi_index !656
  %236 = load float* %235, align 4, !llfi_index !657
  %237 = load float* %235, align 4, !llfi_index !657
  %238 = fpext float %236 to double, !llfi_index !658
  %239 = fpext float %237 to double, !llfi_index !658
  %240 = fadd double %238, %231, !llfi_index !659
  %241 = fadd double %239, %231, !llfi_index !659
  %242 = fptrunc double %240 to float, !llfi_index !660
  %243 = fptrunc double %241 to float, !llfi_index !660
  %check_cmp17 = fcmp ueq float %242, %243
  br i1 %check_cmp17, label %244, label %checkBb18

checkBb18:                                        ; preds = %213
  call void @check_flag()
  br label %244

; <label>:244                                     ; preds = %checkBb18, %213
  store float %242, float* %235, align 4, !llfi_index !661
  %245 = load double* %ti, align 8, !llfi_index !662
  %246 = load i32* %j, align 4, !llfi_index !663
  %247 = zext i32 %246 to i64, !llfi_index !664
  %248 = load float** %6, align 8, !llfi_index !665
  %249 = getelementptr inbounds float* %248, i64 %247, !llfi_index !666
  %250 = load float* %249, align 4, !llfi_index !667
  %251 = fpext float %250 to double, !llfi_index !668
  %252 = fadd double %251, %245, !llfi_index !669
  %253 = fptrunc double %252 to float, !llfi_index !670
  store float %253, float* %249, align 4, !llfi_index !671
  br label %254, !llfi_index !672

; <label>:254                                     ; preds = %244
  %255 = load i32* %j, align 4, !llfi_index !673
  %256 = add i32 %255, 1, !llfi_index !674
  store i32 %256, i32* %j, align 4, !llfi_index !675
  %257 = load i32* %n, align 4, !llfi_index !676
  %258 = add i32 %257, 1, !llfi_index !677
  store i32 %258, i32* %n, align 4, !llfi_index !678
  br label %116, !llfi_index !679

; <label>:259                                     ; preds = %122
  br label %260, !llfi_index !680

; <label>:260                                     ; preds = %259
  %261 = load i32* %BlockSize, align 4, !llfi_index !681
  %262 = load i32* %i, align 4, !llfi_index !682
  %263 = add i32 %262, %261, !llfi_index !683
  store i32 %263, i32* %i, align 4, !llfi_index !684
  br label %99, !llfi_index !685

; <label>:264                                     ; preds = %105
  %265 = load i32* %BlockSize, align 4, !llfi_index !686
  store i32 %265, i32* %BlockEnd, align 4, !llfi_index !687
  br label %266, !llfi_index !688

; <label>:266                                     ; preds = %264
  %267 = load i32* %BlockSize, align 4, !llfi_index !689
  %268 = shl i32 %267, 1, !llfi_index !690
  store i32 %268, i32* %BlockSize, align 4, !llfi_index !691
  br label %76, !llfi_index !692

; <label>:269                                     ; preds = %76
  %270 = load i32* %2, align 4, !llfi_index !693
  %271 = icmp ne i32 %270, 0, !llfi_index !694
  br i1 %271, label %272, label %302, !llfi_index !695

; <label>:272                                     ; preds = %269
  %273 = load i32* %1, align 4, !llfi_index !696
  %274 = uitofp i32 %273 to double, !llfi_index !697
  store double %274, double* %denom, align 8, !llfi_index !698
  store i32 0, i32* %i, align 4, !llfi_index !699
  br label %275, !llfi_index !700

; <label>:275                                     ; preds = %298, %272
  %276 = load i32* %i, align 4, !llfi_index !701
  %277 = load i32* %1, align 4, !llfi_index !702
  %278 = icmp ult i32 %276, %277, !llfi_index !703
  br i1 %278, label %279, label %301, !llfi_index !704

; <label>:279                                     ; preds = %275
  %280 = load double* %denom, align 8, !llfi_index !705
  %281 = load i32* %i, align 4, !llfi_index !706
  %282 = zext i32 %281 to i64, !llfi_index !707
  %283 = load float** %5, align 8, !llfi_index !708
  %284 = getelementptr inbounds float* %283, i64 %282, !llfi_index !709
  %285 = load float* %284, align 4, !llfi_index !710
  %286 = fpext float %285 to double, !llfi_index !711
  %287 = fdiv double %286, %280, !llfi_index !712
  %288 = fptrunc double %287 to float, !llfi_index !713
  store float %288, float* %284, align 4, !llfi_index !714
  %289 = load double* %denom, align 8, !llfi_index !715
  %290 = load i32* %i, align 4, !llfi_index !716
  %291 = zext i32 %290 to i64, !llfi_index !717
  %292 = load float** %6, align 8, !llfi_index !718
  %293 = getelementptr inbounds float* %292, i64 %291, !llfi_index !719
  %294 = load float* %293, align 4, !llfi_index !720
  %295 = fpext float %294 to double, !llfi_index !721
  %296 = fdiv double %295, %289, !llfi_index !722
  %297 = fptrunc double %296 to float, !llfi_index !723
  store float %297, float* %293, align 4, !llfi_index !724
  br label %298, !llfi_index !725

; <label>:298                                     ; preds = %279
  %299 = load i32* %i, align 4, !llfi_index !726
  %300 = add i32 %299, 1, !llfi_index !727
  store i32 %300, i32* %i, align 4, !llfi_index !728
  br label %275, !llfi_index !729

; <label>:301                                     ; preds = %275
  br label %302, !llfi_index !730
