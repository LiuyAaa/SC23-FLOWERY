...
; <label>:205                                     ; preds = %178
  ...
  %216 = fpext float %214 to double, !llfi_index !258
  %217 = fpext float %215 to double, !llfi_index !258
...
; <label>:220                                     ; preds = %checkBb12, %205
  ...
  %228 = fcmp olt double %216, %226, !llfi_index !265
  %229 = fcmp olt double %217, %227, !llfi_index !265
  %check_cmp13 = icmp eq i1 %228, %229
