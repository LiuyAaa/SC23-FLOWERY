...
define i32 @compare(i8* %elem1, i8* %elem2) #0 {
  ...
  %6 = getelementptr inbounds %struct.myStringStruct* %5, i32 0, i32 0, !llfi_index !8
  %7 = getelementptr inbounds [128 x i8]* %6, i32 0, i32 0, !llfi_index !9
  %8 = load i8** %2, align 8, !llfi_index !10
  %9 = load i8** %2, align 8, !llfi_index !10
  %10 = bitcast i8* %8 to %struct.myStringStruct*, !llfi_index !11
  %11 = bitcast i8* %9 to %struct.myStringStruct*, !llfi_index !11
  %12 = getelementptr inbounds %struct.myStringStruct* %10, i32 0, i32 0, !llfi_index !12
  %13 = getelementptr inbounds %struct.myStringStruct* %11, i32 0, i32 0, !llfi_index !12
  %14 = getelementptr inbounds [128 x i8]* %12, i32 0, i32 0, !llfi_index !13
  %15 = getelementptr inbounds [128 x i8]* %13, i32 0, i32 0, !llfi_index !13
...
; <label>:16                                      ; preds = %checkBb, %0
  %17 = call i32 @strcmp(i8* %7, i8* %14) #4, !llfi_index !14
  store i32 %17, i32* %result, align 4, !llfi_index !15
  %18 = load i32* %result, align 4, !llfi_index !16
  %19 = icmp slt i32 %18, 0, !llfi_index !17
  %20 = icmp slt i32 %18, 0, !llfi_index !17
...
; <label>:21                                      ; preds = %checkBb2, %16
  br i1 %19, label %22, label %23, !llfi_index !18

; <label>:22                                      ; preds = %21
  br label %27, !llfi_index !19

; <label>:23                                      ; preds = %21
  %24 = load i32* %result, align 4, !llfi_index !20
  %25 = icmp eq i32 %24, 0, !llfi_index !21
  %26 = select i1 %25, i32 0, i32 -1, !llfi_index !22
  br label %27, !llfi_index !23

; <label>:27                                      ; preds = %23, %22
  %28 = phi i32 [ 1, %22 ], [ %26, %23 ], !llfi_index !24
  ret i32 %28, !llfi_index !25
}
...
; <label>:57                                      ; preds = %checkBb8, %51
  br i1 %55, label %58, label %76, !llfi_index !80
...
; <label>:61                                      ; preds = %checkBb10, %58
  %62 = sext i32 %59 to i64, !llfi_index !82
  %63 = getelementptr inbounds [60000 x %struct.myStringStruct]* %array, i32 0, i64 %62, !llfi_index !83
  ...
  %check_cmp11 = icmp eq [128 x i8]* %65, %66
...
; <label>:67                                      ; preds = %checkBb12, %61
  %68 = getelementptr inbounds [128 x i8]* %65, i32 0, i32 0, !llfi_index !85
  %69 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([4 x i8]* @.str4, i32 0, i32 0), i8* %68), !llfi_index !86
  br label %70, !llfi_index !87

; <label>:70                                      ; preds = %67
  %71 = load i32* %i, align 4, !llfi_index !88
  %72 = load i32* %i, align 4, !llfi_index !88
  %73 = add nsw i32 %71, 1, !llfi_index !89
...
; <label>:75                                      ; preds = %checkBb14, %70
  store i32 %73, i32* %i, align 4, !llfi_index !90
