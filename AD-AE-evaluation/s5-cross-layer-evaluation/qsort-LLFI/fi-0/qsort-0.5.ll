...
define i32 @compare(i8* %elem1, i8* %elem2) #0 {
  ...
  %check_cmp = icmp eq %struct.myStringStruct* %5, %6
...
; <label>:7                                       ; preds = %checkBb, %0
  %8 = getelementptr inbounds %struct.myStringStruct* %5, i32 0, i32 0, !llfi_index !8
  %9 = getelementptr inbounds [128 x i8]* %8, i32 0, i32 0, !llfi_index !9
  %10 = load i8** %2, align 8, !llfi_index !10
  %11 = load i8** %2, align 8, !llfi_index !10
  %12 = bitcast i8* %10 to %struct.myStringStruct*, !llfi_index !11
  %13 = bitcast i8* %11 to %struct.myStringStruct*, !llfi_index !11
  %14 = getelementptr inbounds %struct.myStringStruct* %12, i32 0, i32 0, !llfi_index !12
  %15 = getelementptr inbounds %struct.myStringStruct* %13, i32 0, i32 0, !llfi_index !12
  %16 = getelementptr inbounds [128 x i8]* %14, i32 0, i32 0, !llfi_index !13
...
; <label>:23                                      ; preds = %checkBb4, %18
  br i1 %21, label %24, label %25, !llfi_index !18

; <label>:24                                      ; preds = %23
  br label %29, !llfi_index !19

; <label>:25                                      ; preds = %23
  %26 = load i32* %result, align 4, !llfi_index !20
  %27 = icmp eq i32 %26, 0, !llfi_index !21
  %28 = select i1 %27, i32 0, i32 -1, !llfi_index !22
  br label %29, !llfi_index !23

; <label>:29                                      ; preds = %25, %24
  %30 = phi i32 [ 1, %24 ], [ %28, %25 ], !llfi_index !24
  ret i32 %30, !llfi_index !25
}
