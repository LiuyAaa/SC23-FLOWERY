...
define i32 @compare(i8* %elem1, i8* %elem2) #0 {
  ...
  %10 = getelementptr inbounds %struct.myStringStruct* %9, i32 0, i32 0, !llfi_index !12
  %11 = getelementptr inbounds [128 x i8]* %10, i32 0, i32 0, !llfi_index !13
  %12 = call i32 @strcmp(i8* %6, i8* %11) #4, !llfi_index !14
  store i32 %12, i32* %result, align 4, !llfi_index !15
  %13 = load i32* %result, align 4, !llfi_index !16
  %14 = icmp slt i32 %13, 0, !llfi_index !17
  %15 = icmp slt i32 %13, 0, !llfi_index !17
...
; <label>:16                                      ; preds = %checkBb, %0
  br i1 %14, label %17, label %18, !llfi_index !18

; <label>:17                                      ; preds = %16
  br label %22, !llfi_index !19

; <label>:18                                      ; preds = %16
  %19 = load i32* %result, align 4, !llfi_index !20
  %20 = icmp eq i32 %19, 0, !llfi_index !21
  %21 = select i1 %20, i32 0, i32 -1, !llfi_index !22
  br label %22, !llfi_index !23

; <label>:22                                      ; preds = %18, %17
  %23 = phi i32 [ 1, %17 ], [ %21, %18 ], !llfi_index !24
  ret i32 %23, !llfi_index !25
}
