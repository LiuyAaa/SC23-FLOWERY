...
define i32 @compare(i8* %elem1, i8* %elem2) #0 {
  ...
  %9 = bitcast i8* %7 to %struct.myStringStruct*, !llfi_index !11
  %10 = bitcast i8* %8 to %struct.myStringStruct*, !llfi_index !11
  %check_cmp = icmp eq %struct.myStringStruct* %9, %10
...
; <label>:11                                      ; preds = %checkBb, %0
  %12 = getelementptr inbounds %struct.myStringStruct* %9, i32 0, i32 0, !llfi_index !12
  %13 = getelementptr inbounds [128 x i8]* %12, i32 0, i32 0, !llfi_index !13
...
; <label>:15                                      ; preds = %checkBb2, %11
  %16 = call i32 @strcmp(i8* %6, i8* %13) #4, !llfi_index !14
  store i32 %16, i32* %result, align 4, !llfi_index !15
  %17 = load i32* %result, align 4, !llfi_index !16
  %18 = icmp slt i32 %17, 0, !llfi_index !17
  %19 = icmp slt i32 %17, 0, !llfi_index !17
...
; <label>:20                                      ; preds = %checkBb4, %15
  br i1 %18, label %21, label %22, !llfi_index !18

; <label>:21                                      ; preds = %20
  br label %26, !llfi_index !19

; <label>:22                                      ; preds = %20
  %23 = load i32* %result, align 4, !llfi_index !20
  %24 = icmp eq i32 %23, 0, !llfi_index !21
  %25 = select i1 %24, i32 0, i32 -1, !llfi_index !22
  br label %26, !llfi_index !23

; <label>:26                                      ; preds = %22, %21
  %27 = phi i32 [ 1, %21 ], [ %25, %22 ], !llfi_index !24
  ret i32 %27, !llfi_index !25
}
