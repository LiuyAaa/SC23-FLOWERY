...
; <label>:6                                       ; preds = %13, %4
  ...
  br i1 %8, label %9, label %16, !llfi_index !11

; <label>:9                                       ; preds = %6
  %10 = load i64* @len, align 8, !llfi_index !12
  %11 = load i64* %i, align 8, !llfi_index !13
  %12 = getelementptr inbounds [256 x i64]* @table, i32 0, i64 %11, !llfi_index !14
  store i64 %10, i64* %12, align 8, !llfi_index !15
  br label %13, !llfi_index !16

; <label>:13                                      ; preds = %9
  %14 = load i64* %i, align 8, !llfi_index !17
  %15 = add i64 %14, 1, !llfi_index !18
  store i64 %15, i64* %i, align 8, !llfi_index !19
  br label %6, !llfi_index !20

; <label>:16                                      ; preds = %6
  store i64 0, i64* %i, align 8, !llfi_index !21
  br label %17, !llfi_index !22

; <label>:17                                      ; preds = %52, %16
  %18 = load i64* %i, align 8, !llfi_index !23
  %19 = load i64* %i, align 8, !llfi_index !23
  %20 = load i64* @len, align 8, !llfi_index !24
  %21 = icmp ult i64 %18, %20, !llfi_index !25
  %22 = icmp ult i64 %19, %20, !llfi_index !25
...
; <label>:23                                      ; preds = %checkBb2, %17
  br i1 %21, label %24, label %53, !llfi_index !26

; <label>:24                                      ; preds = %23
  %25 = load i64* @len, align 8, !llfi_index !27
  %26 = load i64* @len, align 8, !llfi_index !27
  %27 = load i64* %i, align 8, !llfi_index !28
  %28 = load i64* %i, align 8, !llfi_index !28
  %29 = sub i64 %25, %27, !llfi_index !29
  %30 = sub i64 %26, %28, !llfi_index !29
  %31 = sub i64 %29, 1, !llfi_index !30
  %32 = sub i64 %30, 1, !llfi_index !30
...
; <label>:33                                      ; preds = %checkBb4, %24
  %34 = load i64* %i, align 8, !llfi_index !31
  %35 = load i64* %i, align 8, !llfi_index !31
  %36 = load i8** %1, align 8, !llfi_index !32
  %37 = load i8** %1, align 8, !llfi_index !32
  %38 = getelementptr inbounds i8* %36, i64 %34, !llfi_index !33
  %39 = getelementptr inbounds i8* %37, i64 %35, !llfi_index !33
  %40 = load i8* %38, align 1, !llfi_index !34
  %41 = load i8* %39, align 1, !llfi_index !34
  %42 = zext i8 %40 to i64, !llfi_index !35
  %43 = zext i8 %41 to i64, !llfi_index !35
  %44 = getelementptr inbounds [256 x i64]* @table, i32 0, i64 %42, !llfi_index !36
  %45 = getelementptr inbounds [256 x i64]* @table, i32 0, i64 %43, !llfi_index !36
...
; <label>:46                                      ; preds = %checkBb6, %33
  store i64 %31, i64* %44, align 8, !llfi_index !37
  br label %47, !llfi_index !38

; <label>:47                                      ; preds = %46
  %48 = load i64* %i, align 8, !llfi_index !39
  %49 = load i64* %i, align 8, !llfi_index !39
  %50 = add i64 %48, 1, !llfi_index !40
  %51 = add i64 %49, 1, !llfi_index !40
...
; <label>:52                                      ; preds = %checkBb8, %47
  store i64 %50, i64* %i, align 8, !llfi_index !41
  br label %17, !llfi_index !42

; <label>:53                                      ; preds = %23
  %54 = load i8** %1, align 8, !llfi_index !43
  %55 = load i8** %1, align 8, !llfi_index !43
  %check_cmp9 = icmp eq i8* %54, %55
...
; <label>:56                                      ; preds = %checkBb10, %53
  store i8* %54, i8** @findme, align 8, !llfi_index !44
