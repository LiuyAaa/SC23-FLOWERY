...
; <label>:125                                     ; preds = %checkBb, %121
  br i1 %123, label %126, label %203, !llfi_index !362
...
; <label>:126                                     ; preds = %125
  ...
  br i1 %150, label %151, label %197, !llfi_index !390
...
; <label>:151                                     ; preds = %126
  ...
  %159 = load double* %t2, align 8, !llfi_index !399
  %160 = fmul double %158, %159, !llfi_index !400
  store double %160, double* %t3, align 8, !llfi_index !401
  %161 = load double* %x2, align 8, !llfi_index !402
  %162 = load double* %t2, align 8, !llfi_index !403
  %163 = fmul double %161, %162, !llfi_index !404
  store double %163, double* %t4, align 8, !llfi_index !405
  %164 = load double* %t3, align 8, !llfi_index !406
  %165 = call double @fabs(double %164) #6, !llfi_index !407
  %166 = load double* %t4, align 8, !llfi_index !408
  %167 = call double @fabs(double %166) #6, !llfi_index !409
  %168 = fcmp ogt double %165, %167, !llfi_index !410
  br i1 %168, label %169, label %172, !llfi_index !411

; <label>:169                                     ; preds = %151
  %170 = load double* %t3, align 8, !llfi_index !412
  %171 = call double @fabs(double %170) #6, !llfi_index !413
  br label %175, !llfi_index !414

; <label>:172                                     ; preds = %151
  %173 = load double* %t4, align 8, !llfi_index !415
  %174 = call double @fabs(double %173) #6, !llfi_index !416
  br label %175, !llfi_index !417

; <label>:175                                     ; preds = %172, %169
  %176 = phi double [ %171, %169 ], [ %174, %172 ], !llfi_index !418
  %177 = fptosi double %176 to i32, !llfi_index !419
  store i32 %177, i32* %l, align 4, !llfi_index !420
  %178 = load i32* %l, align 4, !llfi_index !421
  %179 = sext i32 %178 to i64, !llfi_index !422
  %180 = getelementptr inbounds [10 x double]* @q, i32 0, i64 %179, !llfi_index !423
  %181 = load double* %180, align 8, !llfi_index !424
  %182 = fadd double %181, 1.000000e+00, !llfi_index !425
  %183 = load i32* %l, align 4, !llfi_index !426
  %184 = sext i32 %183 to i64, !llfi_index !427
  %185 = getelementptr inbounds [10 x double]* @q, i32 0, i64 %184, !llfi_index !428
  store double %182, double* %185, align 8, !llfi_index !429
  %186 = load double* %sx, align 8, !llfi_index !430
  %187 = load double* %sx, align 8, !llfi_index !430
  %188 = load double* %t3, align 8, !llfi_index !431
  %189 = fadd double %186, %188, !llfi_index !432
  %190 = fadd double %187, %188, !llfi_index !432
  %check_cmp1 = fcmp ueq double %189, %190
  br i1 %check_cmp1, label %191, label %checkBb2

checkBb2:                                         ; preds = %175
  call void @check_flag()
  br label %191

; <label>:191                                     ; preds = %checkBb2, %175
  store double %189, double* %sx, align 8, !llfi_index !433
  %192 = load double* %sy, align 8, !llfi_index !434
  %193 = load double* %t4, align 8, !llfi_index !435
  %194 = fadd double %192, %193, !llfi_index !436
  %195 = fadd double %192, %193, !llfi_index !436
  %check_cmp3 = fcmp ueq double %194, %195
...
; <label>:196                                     ; preds = %checkBb4, %191
  store double %194, double* %sy, align 8, !llfi_index !437
  br label %197, !llfi_index !438

; <label>:197                                     ; preds = %196, %126
  br label %198, !llfi_index !439

; <label>:198                                     ; preds = %197
  %199 = load i32* %i, align 4, !llfi_index !440
  %200 = add nsw i32 %199, 1, !llfi_index !441
  %201 = add nsw i32 %199, 1, !llfi_index !441
...
; <label>:202                                     ; preds = %checkBb6, %198
  store i32 %200, i32* %i, align 4, !llfi_index !442
  br label %121, !llfi_index !443

; <label>:203                                     ; preds = %125
  %204 = load i32* %timers_enabled, align 4, !llfi_index !444
  %205 = icmp ne i32 %204, 0, !llfi_index !445
  br i1 %205, label %206, label %207, !llfi_index !446

; <label>:206                                     ; preds = %203
  call void @timer_stop(i32 1), !llfi_index !447
  br label %207, !llfi_index !448

; <label>:207                                     ; preds = %206, %203
  br label %208, !llfi_index !449

; <label>:208                                     ; preds = %207
  %209 = load i32* %k, align 4, !llfi_index !450
  %210 = add nsw i32 %209, 1, !llfi_index !451
  store i32 %210, i32* %k, align 4, !llfi_index !452
  br label %75, !llfi_index !453

; <label>:211                                     ; preds = %75
  store i32 0, i32* %i, align 4, !llfi_index !454
  br label %212, !llfi_index !455

; <label>:212                                     ; preds = %222, %211
  %213 = load i32* %i, align 4, !llfi_index !456
  %214 = icmp slt i32 %213, 10, !llfi_index !457
  br i1 %214, label %215, label %225, !llfi_index !458

; <label>:215                                     ; preds = %212
  %216 = load double* %gc, align 8, !llfi_index !459
  %217 = load i32* %i, align 4, !llfi_index !460
  %218 = sext i32 %217 to i64, !llfi_index !461
  %219 = getelementptr inbounds [10 x double]* @q, i32 0, i64 %218, !llfi_index !462
  %220 = load double* %219, align 8, !llfi_index !463
  %221 = fadd double %216, %220, !llfi_index !464
  store double %221, double* %gc, align 8, !llfi_index !465
  br label %222, !llfi_index !466

; <label>:222                                     ; preds = %215
  %223 = load i32* %i, align 4, !llfi_index !467
  %224 = add nsw i32 %223, 1, !llfi_index !468
  store i32 %224, i32* %i, align 4, !llfi_index !469
  br label %212, !llfi_index !470

; <label>:225                                     ; preds = %212
  call void @timer_stop(i32 0), !llfi_index !471
  %226 = call double @timer_read(i32 0), !llfi_index !472
  store double %226, double* %tm, align 8, !llfi_index !473
  ...
  %227 = load i32* %verified, align 4, !llfi_index !478
  %228 = icmp ne i32 %227, 0, !llfi_index !479
  br i1 %228, label %229, label %250, !llfi_index !480

; <label>:229                                     ; preds = %225
  %230 = load double* %sx, align 8, !llfi_index !481
  %231 = load double* %sx_verify_value, align 8, !llfi_index !482
  %232 = fsub double %230, %231, !llfi_index !483
  %233 = load double* %sx_verify_value, align 8, !llfi_index !484
  %234 = fdiv double %232, %233, !llfi_index !485
  %235 = call double @fabs(double %234) #6, !llfi_index !486
  store double %235, double* %sx_err, align 8, !llfi_index !487
  %236 = load double* %sy, align 8, !llfi_index !488
  %237 = load double* %sy_verify_value, align 8, !llfi_index !489
  %238 = fsub double %236, %237, !llfi_index !490
  %239 = load double* %sy_verify_value, align 8, !llfi_index !491
  %240 = fdiv double %238, %239, !llfi_index !492
  %241 = call double @fabs(double %240) #6, !llfi_index !493
  store double %241, double* %sy_err, align 8, !llfi_index !494
  %242 = load double* %sx_err, align 8, !llfi_index !495
  %243 = fcmp ole double %242, 1.000000e-08, !llfi_index !496
  br i1 %243, label %244, label %247, !llfi_index !497

; <label>:244                                     ; preds = %229
  %245 = load double* %sy_err, align 8, !llfi_index !498
  %246 = fcmp ole double %245, 1.000000e-08, !llfi_index !499
  br label %247, !llfi_index !500

; <label>:247                                     ; preds = %244, %229
  %248 = phi i1 [ false, %229 ], [ %246, %244 ], !llfi_index !501
  %249 = zext i1 %248 to i32, !llfi_index !502
  store i32 %249, i32* %verified, align 4, !llfi_index !503
  br label %250, !llfi_index !504

; <label>:250                                     ; preds = %247, %225
  %251 = call double @pow(double 2.000000e+00, double 2.600000e+01) #2, !llfi_index !505
  %252 = load double* %tm, align 8, !llfi_index !506
  %253 = fdiv double %251, %252, !llfi_index !507
  %254 = fdiv double %253, 1.000000e+06, !llfi_index !508
  store double %254, double* %Mops, align 8, !llfi_index !509
  %255 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([25 x i8]* @.str531, i32 0, i32 0)), !llfi_index !510
  %256 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([11 x i8]* @.str632, i32 0, i32 0), i32 25), !llfi_index !511
  %257 = load double* %gc, align 8, !llfi_index !512
  %258 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([30 x i8]* @.str733, i32 0, i32 0), double %257), !llfi_index !513
  %259 = load double* %sx, align 8, !llfi_index !514
  %260 = load double* %sy, align 8, !llfi_index !515
  %261 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([26 x i8]* @.str834, i32 0, i32 0), double %259, double %260), !llfi_index !516
  %262 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([10 x i8]* @.str935, i32 0, i32 0)), !llfi_index !517
  store i32 0, i32* %i, align 4, !llfi_index !518
  br label %263, !llfi_index !519

; <label>:263                                     ; preds = %273, %250
  %264 = load i32* %i, align 4, !llfi_index !520
  %265 = icmp slt i32 %264, 10, !llfi_index !521
  br i1 %265, label %266, label %276, !llfi_index !522

; <label>:266                                     ; preds = %263
  %267 = load i32* %i, align 4, !llfi_index !523
  %268 = load i32* %i, align 4, !llfi_index !524
  %269 = sext i32 %268 to i64, !llfi_index !525
  %270 = getelementptr inbounds [10 x double]* @q, i32 0, i64 %269, !llfi_index !526
  %271 = load double* %270, align 8, !llfi_index !527
  %272 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([12 x i8]* @.str1036, i32 0, i32 0), i32 %267, double %271), !llfi_index !528
  br label %273, !llfi_index !529

; <label>:273                                     ; preds = %266
  %274 = load i32* %i, align 4, !llfi_index !530
  %275 = add nsw i32 %274, 1, !llfi_index !531
  store i32 %275, i32* %i, align 4, !llfi_index !532
  br label %263, !llfi_index !533

; <label>:276                                     ; preds = %263
  %277 = load i32* %nit, align 4, !llfi_index !534
  %278 = load double* %tm, align 8, !llfi_index !535
  %279 = load double* %Mops, align 8, !llfi_index !536
  %280 = load i32* %verified, align 4, !llfi_index !537
  call void @print_results(i8* getelementptr inbounds ([3 x i8]* @.str1137, i32 0, i32 0), i8 signext 87, i32 26, i32 0, i32 0, i32 %277, double %278, double %279, i8* getelementptr inbounds ([25 x i8]* @.str1238, i32 0, i32 0), i32 %280, i8* getelementptr inbounds ([6 x i8]* @.str1339, i32 0, i32 0), i8* getelementptr inbounds ([12 x i8]* @.str1440, i32 0, i32 0), i8* getelementptr inbounds ([34 x i8]* @.str1541, i32 0, i32 0), i8* getelementptr inbounds ([6 x i8]* @.str1642, i32 0, i32 0), i8* getelementptr inbounds ([4 x i8]* @.str1743, i32 0, i32 0), i8* getelementptr inbounds ([12 x i8]* @.str1844, i32 0, i32 0), i8* getelementptr inbounds ([14 x i8]* @.str1945, i32 0, i32 0), i8* getelementptr inbounds ([7 x i8]* @.str2046, i32 0, i32 0), i8* getelementptr inbounds ([7 x i8]* @.str2147, i32 0, i32 0)), !llfi_index !538
  %281 = load i32* %timers_enabled, align 4, !llfi_index !539
  %282 = icmp ne i32 %281, 0, !llfi_index !540
  br i1 %282, label %283, label %309, !llfi_index !541

; <label>:283                                     ; preds = %276
  %284 = load double* %tm, align 8, !llfi_index !542
  %285 = fcmp ole double %284, 0.000000e+00, !llfi_index !543
  br i1 %285, label %286, label %287, !llfi_index !544

; <label>:286                                     ; preds = %283
  store double 1.000000e+00, double* %tm, align 8, !llfi_index !545
  br label %287, !llfi_index !546

; <label>:287                                     ; preds = %286, %283
  %288 = call double @timer_read(i32 0), !llfi_index !547
  store double %288, double* %tt, align 8, !llfi_index !548
  %289 = load double* %tt, align 8, !llfi_index !549
  %290 = load double* %tt, align 8, !llfi_index !550
  %291 = fmul double %290, 1.000000e+02, !llfi_index !551
  %292 = load double* %tm, align 8, !llfi_index !552
  %293 = fdiv double %291, %292, !llfi_index !553
  %294 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([34 x i8]* @.str2248, i32 0, i32 0), double %289, double %293), !llfi_index !554
  %295 = call double @timer_read(i32 1), !llfi_index !555
  store double %295, double* %tt, align 8, !llfi_index !556
  %296 = load double* %tt, align 8, !llfi_index !557
  %297 = load double* %tt, align 8, !llfi_index !558
  %298 = fmul double %297, 1.000000e+02, !llfi_index !559
  %299 = load double* %tm, align 8, !llfi_index !560
  %300 = fdiv double %298, %299, !llfi_index !561
  %301 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([33 x i8]* @.str2349, i32 0, i32 0), double %296, double %300), !llfi_index !562
  %302 = call double @timer_read(i32 2), !llfi_index !563
  store double %302, double* %tt, align 8, !llfi_index !564
  %303 = load double* %tt, align 8, !llfi_index !565
  %304 = load double* %tt, align 8, !llfi_index !566
  %305 = fmul double %304, 1.000000e+02, !llfi_index !567
  %306 = load double* %tm, align 8, !llfi_index !568
  %307 = fdiv double %305, %306, !llfi_index !569
  %308 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([33 x i8]* @.str2450, i32 0, i32 0), double %303, double %307), !llfi_index !570
  br label %309, !llfi_index !571

; <label>:309                                     ; preds = %287, %276
...
; <label>:19                                      ; preds = %checkBb, %14
  br i1 %17, label %20, label %103, !llfi_index !822
...
; <label>:20                                      ; preds = %19
  ...
  %26 = sitofp i32 %25 to double, !llfi_index !829
...
; <label>:28                                      ; preds = %checkBb2, %20
  store double %26, double* %x1, align 8, !llfi_index !830
  %29 = load double** %2, align 8, !llfi_index !831
  %30 = load double* %29, align 8, !llfi_index !832
  %31 = load double* %29, align 8, !llfi_index !832
  %32 = load double* %x1, align 8, !llfi_index !833
  %33 = load double* %x1, align 8, !llfi_index !833
  %34 = fmul double 8.388608e+06, %32, !llfi_index !834
  %35 = fmul double 8.388608e+06, %33, !llfi_index !834
  %36 = fsub double %30, %34, !llfi_index !835
...
; <label>:38                                      ; preds = %checkBb4, %28
  store double %36, double* %x2, align 8, !llfi_index !836
  %39 = load double* %a1, align 8, !llfi_index !837
  %40 = load double* %x2, align 8, !llfi_index !838
  %41 = fmul double %39, %40, !llfi_index !839
  %42 = load double* %a2, align 8, !llfi_index !840
  %43 = load double* %a2, align 8, !llfi_index !840
...
; <label>:44                                      ; preds = %checkBb6, %38
  %45 = load double* %x1, align 8, !llfi_index !841
  %46 = load double* %x1, align 8, !llfi_index !841
...
; <label>:47                                      ; preds = %checkBb8, %44
  %48 = fmul double %42, %45, !llfi_index !842
  %49 = fadd double %41, %48, !llfi_index !843
  store double %49, double* %t1, align 8, !llfi_index !844
  %50 = load double* %t1, align 8, !llfi_index !845
  %51 = fmul double 0x3E80000000000000, %50, !llfi_index !846
  %52 = fptosi double %51 to i32, !llfi_index !847
  %53 = sitofp i32 %52 to double, !llfi_index !848
  %54 = sitofp i32 %52 to double, !llfi_index !848
...
; <label>:55                                      ; preds = %checkBb10, %47
  store double %53, double* %t2, align 8, !llfi_index !849
  %56 = load double* %t1, align 8, !llfi_index !850
  %57 = load double* %t2, align 8, !llfi_index !851
  %58 = fmul double 8.388608e+06, %57, !llfi_index !852
  %59 = fmul double 8.388608e+06, %57, !llfi_index !852
  %60 = fsub double %56, %58, !llfi_index !853
  %61 = fsub double %56, %59, !llfi_index !853
...
; <label>:62                                      ; preds = %checkBb12, %55
  store double %60, double* %z, align 8, !llfi_index !854
  %63 = load double* %z, align 8, !llfi_index !855
  %64 = load double* %z, align 8, !llfi_index !855
  %65 = fmul double 8.388608e+06, %63, !llfi_index !856
  %66 = fmul double 8.388608e+06, %64, !llfi_index !856
  %67 = load double* %a2, align 8, !llfi_index !857
  %68 = load double* %a2, align 8, !llfi_index !857
  %69 = load double* %x2, align 8, !llfi_index !858
  %70 = load double* %x2, align 8, !llfi_index !858
  %71 = fmul double %67, %69, !llfi_index !859
  %72 = fmul double %68, %70, !llfi_index !859
  %73 = fadd double %65, %71, !llfi_index !860
  %74 = fadd double %66, %72, !llfi_index !860
...
; <label>:75                                      ; preds = %checkBb14, %62
  store double %73, double* %t3, align 8, !llfi_index !861
  %76 = load double* %t3, align 8, !llfi_index !862
  %77 = fmul double 0x3D10000000000000, %76, !llfi_index !863
  %78 = fptosi double %77 to i32, !llfi_index !864
  %79 = fptosi double %77 to i32, !llfi_index !864
...
; <label>:80                                      ; preds = %checkBb16, %75
  %81 = sitofp i32 %78 to double, !llfi_index !865
  store double %81, double* %t4, align 8, !llfi_index !866
  %82 = load double* %t3, align 8, !llfi_index !867
  %83 = load double* %t3, align 8, !llfi_index !867
  %84 = load double* %t4, align 8, !llfi_index !868
  %85 = fmul double 0x42D0000000000000, %84, !llfi_index !869
  %86 = fsub double %82, %85, !llfi_index !870
  %87 = fsub double %83, %85, !llfi_index !870
...
; <label>:88                                      ; preds = %checkBb18, %80
  %89 = load double** %2, align 8, !llfi_index !871
  store double %86, double* %89, align 8, !llfi_index !872
  %90 = load double** %2, align 8, !llfi_index !873
  %91 = load double* %90, align 8, !llfi_index !874
  %92 = fmul double 0x3D10000000000000, %91, !llfi_index !875
  %93 = load i32* %i, align 4, !llfi_index !876
  %94 = sext i32 %93 to i64, !llfi_index !877
  %95 = load double** %4, align 8, !llfi_index !878
  %96 = getelementptr inbounds double* %95, i64 %94, !llfi_index !879
  store double %92, double* %96, align 8, !llfi_index !880
  br label %97, !llfi_index !881

; <label>:97                                      ; preds = %88
  %98 = load i32* %i, align 4, !llfi_index !882
  %99 = load i32* %i, align 4, !llfi_index !882
  %100 = add nsw i32 %98, 1, !llfi_index !883
  %101 = add nsw i32 %99, 1, !llfi_index !883
...
; <label>:102                                     ; preds = %checkBb20, %97
  store i32 %100, i32* %i, align 4, !llfi_index !884
