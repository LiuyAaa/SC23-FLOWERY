...
; <label>:19                                      ; preds = %checkBb, %14
  br i1 %17, label %20, label %81, !llfi_index !822
...
; <label>:35                                      ; preds = %checkBb4, %30
  %36 = fsub double %28, %33, !llfi_index !835
  ...
  %41 = load double* %x1, align 8, !llfi_index !841
  %42 = load double* %x1, align 8, !llfi_index !841
...
; <label>:43                                      ; preds = %checkBb6, %35
  %44 = fmul double %40, %41, !llfi_index !842
  %45 = fadd double %39, %44, !llfi_index !843
  store double %45, double* %t1, align 8, !llfi_index !844
  %46 = load double* %t1, align 8, !llfi_index !845
  %47 = fmul double 0x3E80000000000000, %46, !llfi_index !846
  %48 = fptosi double %47 to i32, !llfi_index !847
  %49 = sitofp i32 %48 to double, !llfi_index !848
  store double %49, double* %t2, align 8, !llfi_index !849
  %50 = load double* %t1, align 8, !llfi_index !850
  %51 = load double* %t2, align 8, !llfi_index !851
  %52 = fmul double 8.388608e+06, %51, !llfi_index !852
  %53 = fsub double %50, %52, !llfi_index !853
  store double %53, double* %z, align 8, !llfi_index !854
  %54 = load double* %z, align 8, !llfi_index !855
  %55 = fmul double 8.388608e+06, %54, !llfi_index !856
  %56 = load double* %a2, align 8, !llfi_index !857
  %57 = load double* %x2, align 8, !llfi_index !858
  %58 = fmul double %56, %57, !llfi_index !859
  %59 = fadd double %55, %58, !llfi_index !860
  %60 = fadd double %55, %58, !llfi_index !860
...
; <label>:61                                      ; preds = %checkBb8, %43
  store double %59, double* %t3, align 8, !llfi_index !861
  %62 = load double* %t3, align 8, !llfi_index !862
  %63 = fmul double 0x3D10000000000000, %62, !llfi_index !863
  %64 = fptosi double %63 to i32, !llfi_index !864
  %65 = sitofp i32 %64 to double, !llfi_index !865
  store double %65, double* %t4, align 8, !llfi_index !866
  %66 = load double* %t3, align 8, !llfi_index !867
  %67 = load double* %t4, align 8, !llfi_index !868
  %68 = fmul double 0x42D0000000000000, %67, !llfi_index !869
  %69 = fsub double %66, %68, !llfi_index !870
  %70 = load double** %2, align 8, !llfi_index !871
  store double %69, double* %70, align 8, !llfi_index !872
  %71 = load double** %2, align 8, !llfi_index !873
  %72 = load double* %71, align 8, !llfi_index !874
  %73 = fmul double 0x3D10000000000000, %72, !llfi_index !875
  %74 = load i32* %i, align 4, !llfi_index !876
  %75 = sext i32 %74 to i64, !llfi_index !877
  %76 = load double** %4, align 8, !llfi_index !878
  %77 = getelementptr inbounds double* %76, i64 %75, !llfi_index !879
  store double %73, double* %77, align 8, !llfi_index !880
  br label %78, !llfi_index !881

; <label>:78                                      ; preds = %61
  %79 = load i32* %i, align 4, !llfi_index !882
  %80 = add nsw i32 %79, 1, !llfi_index !883
  store i32 %80, i32* %i, align 4, !llfi_index !884
