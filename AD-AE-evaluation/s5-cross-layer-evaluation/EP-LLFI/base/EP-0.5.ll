...
; <label>:75                                      ; preds = %236, %74
  ...
  br i1 %78, label %79, label %239, !llfi_index !303
...
; <label>:125                                     ; preds = %checkBb, %121
  br i1 %123, label %126, label %231, !llfi_index !362
...
; <label>:126                                     ; preds = %125
  ...
  %134 = fsub double %132, 1.000000e+00, !llfi_index !369
  %check_cmp1 = fcmp ueq double %133, %134
  br i1 %check_cmp1, label %135, label %checkBb2

checkBb2:                                         ; preds = %126
  call void @check_flag()
  br label %135

; <label>:135                                     ; preds = %checkBb2, %126
  store double %133, double* %x1, align 8, !llfi_index !370
  %136 = load i32* %i, align 4, !llfi_index !371
  %137 = mul nsw i32 2, %136, !llfi_index !372
  %138 = add nsw i32 %137, 1, !llfi_index !373
  %139 = sext i32 %138 to i64, !llfi_index !374
  %140 = getelementptr inbounds [131072 x double]* @x, i32 0, i64 %139, !llfi_index !375
  %141 = load double* %140, align 8, !llfi_index !376
  %142 = fmul double 2.000000e+00, %141, !llfi_index !377
  %143 = fsub double %142, 1.000000e+00, !llfi_index !378
  store double %143, double* %x2, align 8, !llfi_index !379
  %144 = load double* %x1, align 8, !llfi_index !380
  %145 = load double* %x1, align 8, !llfi_index !381
  %146 = fmul double %144, %145, !llfi_index !382
  %147 = fmul double %144, %145, !llfi_index !382
  %check_cmp3 = fcmp ueq double %146, %147
...
; <label>:148                                     ; preds = %checkBb4, %135
  %149 = load double* %x2, align 8, !llfi_index !383
  %150 = load double* %x2, align 8, !llfi_index !383
...
; <label>:151                                     ; preds = %checkBb6, %148
  %152 = load double* %x2, align 8, !llfi_index !384
  %153 = load double* %x2, align 8, !llfi_index !384
  %check_cmp7 = fcmp ueq double %152, %153
  br i1 %check_cmp7, label %154, label %checkBb8

checkBb8:                                         ; preds = %151
  call void @check_flag()
  br label %154

; <label>:154                                     ; preds = %checkBb8, %151
  %155 = fmul double %149, %152, !llfi_index !385
  %156 = fadd double %146, %155, !llfi_index !386
  store double %156, double* %t1, align 8, !llfi_index !387
  %157 = load double* %t1, align 8, !llfi_index !388
  %158 = fcmp ole double %157, 1.000000e+00, !llfi_index !389
  %159 = fcmp ole double %157, 1.000000e+00, !llfi_index !389
  %check_cmp9 = icmp eq i1 %158, %159
  br i1 %check_cmp9, label %160, label %checkBb10

checkBb10:                                        ; preds = %154
  call void @check_flag()
  br label %160

; <label>:160                                     ; preds = %checkBb10, %154
  br i1 %158, label %161, label %224, !llfi_index !390

; <label>:161                                     ; preds = %160
  %162 = load double* %t1, align 8, !llfi_index !391
  %163 = load double* %t1, align 8, !llfi_index !391
  %check_cmp11 = fcmp ueq double %162, %163
...
; <label>:164                                     ; preds = %checkBb12, %161
  %165 = call double @log(double %162) #2, !llfi_index !392
  %166 = fmul double -2.000000e+00, %165, !llfi_index !393
  %167 = fmul double -2.000000e+00, %165, !llfi_index !393
  %168 = load double* %t1, align 8, !llfi_index !394
  %169 = load double* %t1, align 8, !llfi_index !394
  %170 = fdiv double %166, %168, !llfi_index !395
  %171 = fdiv double %167, %169, !llfi_index !395
...
; <label>:172                                     ; preds = %checkBb14, %164
  %173 = call double @sqrt(double %170) #2, !llfi_index !396
  store double %173, double* %t2, align 8, !llfi_index !397
  %174 = load double* %x1, align 8, !llfi_index !398
  %175 = load double* %x1, align 8, !llfi_index !398
  %176 = load double* %t2, align 8, !llfi_index !399
  %177 = load double* %t2, align 8, !llfi_index !399
  %178 = fmul double %174, %176, !llfi_index !400
  %179 = fmul double %175, %177, !llfi_index !400
...
; <label>:180                                     ; preds = %checkBb16, %172
  store double %178, double* %t3, align 8, !llfi_index !401
  %181 = load double* %x2, align 8, !llfi_index !402
  %182 = load double* %x2, align 8, !llfi_index !402
  %183 = load double* %t2, align 8, !llfi_index !403
  %184 = load double* %t2, align 8, !llfi_index !403
  %185 = fmul double %181, %183, !llfi_index !404
  %186 = fmul double %182, %184, !llfi_index !404
  %check_cmp17 = fcmp ueq double %185, %186
...
; <label>:187                                     ; preds = %checkBb18, %180
  store double %185, double* %t4, align 8, !llfi_index !405
  %188 = load double* %t3, align 8, !llfi_index !406
  %189 = call double @fabs(double %188) #6, !llfi_index !407
  %190 = load double* %t4, align 8, !llfi_index !408
  %191 = call double @fabs(double %190) #6, !llfi_index !409
  %192 = fcmp ogt double %189, %191, !llfi_index !410
  br i1 %192, label %193, label %196, !llfi_index !411

; <label>:193                                     ; preds = %187
  %194 = load double* %t3, align 8, !llfi_index !412
  %195 = call double @fabs(double %194) #6, !llfi_index !413
  br label %199, !llfi_index !414

; <label>:196                                     ; preds = %187
  %197 = load double* %t4, align 8, !llfi_index !415
  %198 = call double @fabs(double %197) #6, !llfi_index !416
  br label %199, !llfi_index !417

; <label>:199                                     ; preds = %196, %193
  %200 = phi double [ %195, %193 ], [ %198, %196 ], !llfi_index !418
  %201 = fptosi double %200 to i32, !llfi_index !419
  store i32 %201, i32* %l, align 4, !llfi_index !420
  %202 = load i32* %l, align 4, !llfi_index !421
  %203 = sext i32 %202 to i64, !llfi_index !422
  %204 = getelementptr inbounds [10 x double]* @q, i32 0, i64 %203, !llfi_index !423
  %205 = load double* %204, align 8, !llfi_index !424
  %206 = fadd double %205, 1.000000e+00, !llfi_index !425
  %207 = load i32* %l, align 4, !llfi_index !426
  %208 = sext i32 %207 to i64, !llfi_index !427
  %209 = getelementptr inbounds [10 x double]* @q, i32 0, i64 %208, !llfi_index !428
  store double %206, double* %209, align 8, !llfi_index !429
  %210 = load double* %sx, align 8, !llfi_index !430
  %211 = load double* %sx, align 8, !llfi_index !430
  %212 = load double* %t3, align 8, !llfi_index !431
  %213 = load double* %t3, align 8, !llfi_index !431
  %214 = fadd double %210, %212, !llfi_index !432
  %215 = fadd double %211, %213, !llfi_index !432
  %check_cmp19 = fcmp ueq double %214, %215
  br i1 %check_cmp19, label %216, label %checkBb20

checkBb20:                                        ; preds = %199
  call void @check_flag()
  br label %216

; <label>:216                                     ; preds = %checkBb20, %199
  store double %214, double* %sx, align 8, !llfi_index !433
  %217 = load double* %sy, align 8, !llfi_index !434
  %218 = load double* %sy, align 8, !llfi_index !434
  %219 = load double* %t4, align 8, !llfi_index !435
  %220 = load double* %t4, align 8, !llfi_index !435
  %221 = fadd double %217, %219, !llfi_index !436
  %222 = fadd double %218, %220, !llfi_index !436
  %check_cmp21 = fcmp ueq double %221, %222
...
; <label>:223                                     ; preds = %checkBb22, %216
  store double %221, double* %sy, align 8, !llfi_index !437
  br label %224, !llfi_index !438

; <label>:224                                     ; preds = %223, %160
  br label %225, !llfi_index !439

; <label>:225                                     ; preds = %224
  %226 = load i32* %i, align 4, !llfi_index !440
  %227 = load i32* %i, align 4, !llfi_index !440
  %228 = add nsw i32 %226, 1, !llfi_index !441
  %229 = add nsw i32 %227, 1, !llfi_index !441
...
; <label>:230                                     ; preds = %checkBb24, %225
  store i32 %228, i32* %i, align 4, !llfi_index !442
  br label %121, !llfi_index !443

; <label>:231                                     ; preds = %125
  %232 = load i32* %timers_enabled, align 4, !llfi_index !444
  %233 = icmp ne i32 %232, 0, !llfi_index !445
  br i1 %233, label %234, label %235, !llfi_index !446

; <label>:234                                     ; preds = %231
  call void @timer_stop(i32 1), !llfi_index !447
  br label %235, !llfi_index !448

; <label>:235                                     ; preds = %234, %231
  br label %236, !llfi_index !449

; <label>:236                                     ; preds = %235
  %237 = load i32* %k, align 4, !llfi_index !450
  %238 = add nsw i32 %237, 1, !llfi_index !451
  store i32 %238, i32* %k, align 4, !llfi_index !452
  br label %75, !llfi_index !453

; <label>:239                                     ; preds = %75
  store i32 0, i32* %i, align 4, !llfi_index !454
  br label %240, !llfi_index !455

; <label>:240                                     ; preds = %250, %239
  %241 = load i32* %i, align 4, !llfi_index !456
  %242 = icmp slt i32 %241, 10, !llfi_index !457
  br i1 %242, label %243, label %253, !llfi_index !458

; <label>:243                                     ; preds = %240
  %244 = load double* %gc, align 8, !llfi_index !459
  %245 = load i32* %i, align 4, !llfi_index !460
  %246 = sext i32 %245 to i64, !llfi_index !461
  %247 = getelementptr inbounds [10 x double]* @q, i32 0, i64 %246, !llfi_index !462
  %248 = load double* %247, align 8, !llfi_index !463
  %249 = fadd double %244, %248, !llfi_index !464
  store double %249, double* %gc, align 8, !llfi_index !465
  br label %250, !llfi_index !466

; <label>:250                                     ; preds = %243
  %251 = load i32* %i, align 4, !llfi_index !467
  %252 = add nsw i32 %251, 1, !llfi_index !468
  store i32 %252, i32* %i, align 4, !llfi_index !469
  br label %240, !llfi_index !470

; <label>:253                                     ; preds = %240
  call void @timer_stop(i32 0), !llfi_index !471
  %254 = call double @timer_read(i32 0), !llfi_index !472
  store double %254, double* %tm, align 8, !llfi_index !473
  ...
  %255 = load i32* %verified, align 4, !llfi_index !478
  %256 = icmp ne i32 %255, 0, !llfi_index !479
  br i1 %256, label %257, label %278, !llfi_index !480

; <label>:257                                     ; preds = %253
  %258 = load double* %sx, align 8, !llfi_index !481
  %259 = load double* %sx_verify_value, align 8, !llfi_index !482
  %260 = fsub double %258, %259, !llfi_index !483
  %261 = load double* %sx_verify_value, align 8, !llfi_index !484
  %262 = fdiv double %260, %261, !llfi_index !485
  %263 = call double @fabs(double %262) #6, !llfi_index !486
  store double %263, double* %sx_err, align 8, !llfi_index !487
  %264 = load double* %sy, align 8, !llfi_index !488
  %265 = load double* %sy_verify_value, align 8, !llfi_index !489
  %266 = fsub double %264, %265, !llfi_index !490
  %267 = load double* %sy_verify_value, align 8, !llfi_index !491
  %268 = fdiv double %266, %267, !llfi_index !492
  %269 = call double @fabs(double %268) #6, !llfi_index !493
  store double %269, double* %sy_err, align 8, !llfi_index !494
  %270 = load double* %sx_err, align 8, !llfi_index !495
  %271 = fcmp ole double %270, 1.000000e-08, !llfi_index !496
  br i1 %271, label %272, label %275, !llfi_index !497

; <label>:272                                     ; preds = %257
  %273 = load double* %sy_err, align 8, !llfi_index !498
  %274 = fcmp ole double %273, 1.000000e-08, !llfi_index !499
  br label %275, !llfi_index !500

; <label>:275                                     ; preds = %272, %257
  %276 = phi i1 [ false, %257 ], [ %274, %272 ], !llfi_index !501
  %277 = zext i1 %276 to i32, !llfi_index !502
  store i32 %277, i32* %verified, align 4, !llfi_index !503
  br label %278, !llfi_index !504

; <label>:278                                     ; preds = %275, %253
  %279 = call double @pow(double 2.000000e+00, double 2.600000e+01) #2, !llfi_index !505
  %280 = load double* %tm, align 8, !llfi_index !506
  %281 = fdiv double %279, %280, !llfi_index !507
  %282 = fdiv double %281, 1.000000e+06, !llfi_index !508
  store double %282, double* %Mops, align 8, !llfi_index !509
  %283 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([25 x i8]* @.str531, i32 0, i32 0)), !llfi_index !510
  %284 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([11 x i8]* @.str632, i32 0, i32 0), i32 25), !llfi_index !511
  %285 = load double* %gc, align 8, !llfi_index !512
  %286 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([30 x i8]* @.str733, i32 0, i32 0), double %285), !llfi_index !513
  %287 = load double* %sx, align 8, !llfi_index !514
  %288 = load double* %sy, align 8, !llfi_index !515
  %289 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([26 x i8]* @.str834, i32 0, i32 0), double %287, double %288), !llfi_index !516
  %290 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([10 x i8]* @.str935, i32 0, i32 0)), !llfi_index !517
  store i32 0, i32* %i, align 4, !llfi_index !518
  br label %291, !llfi_index !519

; <label>:291                                     ; preds = %301, %278
  %292 = load i32* %i, align 4, !llfi_index !520
  %293 = icmp slt i32 %292, 10, !llfi_index !521
  br i1 %293, label %294, label %304, !llfi_index !522

; <label>:294                                     ; preds = %291
  %295 = load i32* %i, align 4, !llfi_index !523
  %296 = load i32* %i, align 4, !llfi_index !524
  %297 = sext i32 %296 to i64, !llfi_index !525
  %298 = getelementptr inbounds [10 x double]* @q, i32 0, i64 %297, !llfi_index !526
  %299 = load double* %298, align 8, !llfi_index !527
  %300 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([12 x i8]* @.str1036, i32 0, i32 0), i32 %295, double %299), !llfi_index !528
  br label %301, !llfi_index !529

; <label>:301                                     ; preds = %294
  %302 = load i32* %i, align 4, !llfi_index !530
  %303 = add nsw i32 %302, 1, !llfi_index !531
  store i32 %303, i32* %i, align 4, !llfi_index !532
  br label %291, !llfi_index !533

; <label>:304                                     ; preds = %291
  %305 = load i32* %nit, align 4, !llfi_index !534
  %306 = load double* %tm, align 8, !llfi_index !535
  %307 = load double* %Mops, align 8, !llfi_index !536
  %308 = load i32* %verified, align 4, !llfi_index !537
  call void @print_results(i8* getelementptr inbounds ([3 x i8]* @.str1137, i32 0, i32 0), i8 signext 87, i32 26, i32 0, i32 0, i32 %305, double %306, double %307, i8* getelementptr inbounds ([25 x i8]* @.str1238, i32 0, i32 0), i32 %308, i8* getelementptr inbounds ([6 x i8]* @.str1339, i32 0, i32 0), i8* getelementptr inbounds ([12 x i8]* @.str1440, i32 0, i32 0), i8* getelementptr inbounds ([34 x i8]* @.str1541, i32 0, i32 0), i8* getelementptr inbounds ([6 x i8]* @.str1642, i32 0, i32 0), i8* getelementptr inbounds ([4 x i8]* @.str1743, i32 0, i32 0), i8* getelementptr inbounds ([12 x i8]* @.str1844, i32 0, i32 0), i8* getelementptr inbounds ([14 x i8]* @.str1945, i32 0, i32 0), i8* getelementptr inbounds ([7 x i8]* @.str2046, i32 0, i32 0), i8* getelementptr inbounds ([7 x i8]* @.str2147, i32 0, i32 0)), !llfi_index !538
  %309 = load i32* %timers_enabled, align 4, !llfi_index !539
  %310 = icmp ne i32 %309, 0, !llfi_index !540
  br i1 %310, label %311, label %337, !llfi_index !541

; <label>:311                                     ; preds = %304
  %312 = load double* %tm, align 8, !llfi_index !542
  %313 = fcmp ole double %312, 0.000000e+00, !llfi_index !543
  br i1 %313, label %314, label %315, !llfi_index !544

; <label>:314                                     ; preds = %311
  store double 1.000000e+00, double* %tm, align 8, !llfi_index !545
  br label %315, !llfi_index !546

; <label>:315                                     ; preds = %314, %311
  %316 = call double @timer_read(i32 0), !llfi_index !547
  store double %316, double* %tt, align 8, !llfi_index !548
  %317 = load double* %tt, align 8, !llfi_index !549
  %318 = load double* %tt, align 8, !llfi_index !550
  %319 = fmul double %318, 1.000000e+02, !llfi_index !551
  %320 = load double* %tm, align 8, !llfi_index !552
  %321 = fdiv double %319, %320, !llfi_index !553
  %322 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([34 x i8]* @.str2248, i32 0, i32 0), double %317, double %321), !llfi_index !554
  %323 = call double @timer_read(i32 1), !llfi_index !555
  store double %323, double* %tt, align 8, !llfi_index !556
  %324 = load double* %tt, align 8, !llfi_index !557
  %325 = load double* %tt, align 8, !llfi_index !558
  %326 = fmul double %325, 1.000000e+02, !llfi_index !559
  %327 = load double* %tm, align 8, !llfi_index !560
  %328 = fdiv double %326, %327, !llfi_index !561
  %329 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([33 x i8]* @.str2349, i32 0, i32 0), double %324, double %328), !llfi_index !562
  %330 = call double @timer_read(i32 2), !llfi_index !563
  store double %330, double* %tt, align 8, !llfi_index !564
  %331 = load double* %tt, align 8, !llfi_index !565
  %332 = load double* %tt, align 8, !llfi_index !566
  %333 = fmul double %332, 1.000000e+02, !llfi_index !567
  %334 = load double* %tm, align 8, !llfi_index !568
  %335 = fdiv double %333, %334, !llfi_index !569
  %336 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([33 x i8]* @.str2450, i32 0, i32 0), double %331, double %335), !llfi_index !570
  br label %337, !llfi_index !571

; <label>:337                                     ; preds = %315, %304
...
; <label>:19                                      ; preds = %checkBb, %14
  br i1 %17, label %20, label %112, !llfi_index !822
...
; <label>:39                                      ; preds = %checkBb4, %29
  ...
  %42 = load double* %x2, align 8, !llfi_index !838
  %43 = load double* %x2, align 8, !llfi_index !838
  %44 = fmul double %40, %42, !llfi_index !839
  %45 = fmul double %41, %43, !llfi_index !839
  %46 = load double* %a2, align 8, !llfi_index !840
...
; <label>:51                                      ; preds = %checkBb8, %48
  %52 = fmul double %46, %49, !llfi_index !842
  %53 = fadd double %44, %52, !llfi_index !843
  %54 = fadd double %45, %52, !llfi_index !843
...
; <label>:89                                      ; preds = %checkBb18, %84
  ...
  %check_cmp19 = fcmp ueq double %95, %96
...
; <label>:97                                      ; preds = %checkBb20, %89
  ...
  %101 = fmul double 0x3D10000000000000, %100, !llfi_index !875
  %102 = load i32* %i, align 4, !llfi_index !876
  %103 = sext i32 %102 to i64, !llfi_index !877
  %104 = load double** %4, align 8, !llfi_index !878
  %105 = getelementptr inbounds double* %104, i64 %103, !llfi_index !879
  store double %101, double* %105, align 8, !llfi_index !880
  br label %106, !llfi_index !881

; <label>:106                                     ; preds = %97
  %107 = load i32* %i, align 4, !llfi_index !882
  %108 = load i32* %i, align 4, !llfi_index !882
  %109 = add nsw i32 %107, 1, !llfi_index !883
  %110 = add nsw i32 %108, 1, !llfi_index !883
...
; <label>:111                                     ; preds = %checkBb22, %106
  store i32 %109, i32* %i, align 4, !llfi_index !884
