; ModuleID = '/home/foo/multi-bit-flip/initial-study/results/stringsearch/protected-IR/stringsearch.ll'
...
define void @init_search(i8* %string) #0 {
  ...
  %3 = call i64 @strlen(i8* %2) #6, !llfi_index !5
  store i64 %3, i64* @len, align 8, !llfi_index !6
  store i64 0, i64* %i, align 8, !llfi_index !7
  br label %4, !llfi_index !8

; <label>:4                                       ; preds = %11, %0
  %5 = load i64* %i, align 8, !llfi_index !9
  %6 = icmp ule i64 %5, 255, !llfi_index !10
  br i1 %6, label %7, label %14, !llfi_index !11

; <label>:7                                       ; preds = %4
  %8 = load i64* @len, align 8, !llfi_index !12
  %9 = load i64* %i, align 8, !llfi_index !13
  %10 = getelementptr inbounds [256 x i64]* @table, i32 0, i64 %9, !llfi_index !14
  store i64 %8, i64* %10, align 8, !llfi_index !15
  br label %11, !llfi_index !16

; <label>:11                                      ; preds = %7
  %12 = load i64* %i, align 8, !llfi_index !17
  %13 = add i64 %12, 1, !llfi_index !18
  store i64 %13, i64* %i, align 8, !llfi_index !19
  br label %4, !llfi_index !20

; <label>:14                                      ; preds = %4
  store i64 0, i64* %i, align 8, !llfi_index !21
  br label %15, !llfi_index !22

; <label>:15                                      ; preds = %30, %14
  %16 = load i64* %i, align 8, !llfi_index !23
  %17 = load i64* @len, align 8, !llfi_index !24
  %18 = icmp ult i64 %16, %17, !llfi_index !25
  br i1 %18, label %19, label %33, !llfi_index !26

; <label>:19                                      ; preds = %15
  %20 = load i64* @len, align 8, !llfi_index !27
  %21 = load i64* %i, align 8, !llfi_index !28
  %22 = sub i64 %20, %21, !llfi_index !29
  %23 = sub i64 %22, 1, !llfi_index !30
  %24 = load i64* %i, align 8, !llfi_index !31
  %25 = load i8** %1, align 8, !llfi_index !32
  %26 = getelementptr inbounds i8* %25, i64 %24, !llfi_index !33
  %27 = load i8* %26, align 1, !llfi_index !34
  %28 = zext i8 %27 to i64, !llfi_index !35
  %29 = getelementptr inbounds [256 x i64]* @table, i32 0, i64 %28, !llfi_index !36
  store i64 %23, i64* %29, align 8, !llfi_index !37
  br label %30, !llfi_index !38

; <label>:30                                      ; preds = %19
  %31 = load i64* %i, align 8, !llfi_index !39
  %32 = add i64 %31, 1, !llfi_index !40
  store i64 %32, i64* %i, align 8, !llfi_index !41
  br label %15, !llfi_index !42

; <label>:33                                      ; preds = %15
  %34 = load i8** %1, align 8, !llfi_index !43
  store i8* %34, i8** @findme, align 8, !llfi_index !44
...
define i8* @strsearch(i8* %string) #0 {
  ...
  %4 = sub i64 %3, 1, !llfi_index !54
  store i64 %4, i64* %pos, align 8, !llfi_index !55
  %5 = load i8** %2, align 8, !llfi_index !56
  %6 = call i64 @strlen(i8* %5) #6, !llfi_index !57
  store i64 %6, i64* %limit, align 8, !llfi_index !58
  br label %7, !llfi_index !59

; <label>:7                                       ; preds = %51, %0
  %8 = load i64* %pos, align 8, !llfi_index !60
  %9 = load i64* %limit, align 8, !llfi_index !61
  %10 = icmp ult i64 %8, %9, !llfi_index !62
  br i1 %10, label %11, label %52, !llfi_index !63

; <label>:11                                      ; preds = %7
  br label %12, !llfi_index !64

; <label>:12                                      ; preds = %27, %11
  %13 = load i64* %pos, align 8, !llfi_index !65
  %14 = load i64* %limit, align 8, !llfi_index !66
  %15 = icmp ult i64 %13, %14, !llfi_index !67
  br i1 %15, label %16, label %25, !llfi_index !68

; <label>:16                                      ; preds = %12
  %17 = load i64* %pos, align 8, !llfi_index !69
  %18 = load i8** %2, align 8, !llfi_index !70
  %19 = getelementptr inbounds i8* %18, i64 %17, !llfi_index !71
  %20 = load i8* %19, align 1, !llfi_index !72
  %21 = zext i8 %20 to i64, !llfi_index !73
  %22 = getelementptr inbounds [256 x i64]* @table, i32 0, i64 %21, !llfi_index !74
  %23 = load i64* %22, align 8, !llfi_index !75
  store i64 %23, i64* %shift, align 8, !llfi_index !76
  %24 = icmp ugt i64 %23, 0, !llfi_index !77
  br label %25, !llfi_index !78

; <label>:25                                      ; preds = %16, %12
  %26 = phi i1 [ false, %12 ], [ %24, %16 ], !llfi_index !79
  br i1 %26, label %27, label %31, !llfi_index !80

; <label>:27                                      ; preds = %25
  %28 = load i64* %shift, align 8, !llfi_index !81
  %29 = load i64* %pos, align 8, !llfi_index !82
  %30 = add i64 %29, %28, !llfi_index !83
  store i64 %30, i64* %pos, align 8, !llfi_index !84
  br label %12, !llfi_index !85

; <label>:31                                      ; preds = %25
  %32 = load i64* %shift, align 8, !llfi_index !86
  %33 = icmp eq i64 0, %32, !llfi_index !87
  br i1 %33, label %34, label %51, !llfi_index !88

; <label>:34                                      ; preds = %31
  %35 = load i8** @findme, align 8, !llfi_index !89
  %36 = load i64* %pos, align 8, !llfi_index !90
  %37 = load i64* @len, align 8, !llfi_index !91
  %38 = sub i64 %36, %37, !llfi_index !92
  %39 = add i64 %38, 1, !llfi_index !93
  %40 = load i8** %2, align 8, !llfi_index !94
  %41 = getelementptr inbounds i8* %40, i64 %39, !llfi_index !95
  store i8* %41, i8** %here, align 8, !llfi_index !96
  %42 = load i64* @len, align 8, !llfi_index !97
  %43 = call i32 @strncmp(i8* %35, i8* %41, i64 %42) #6, !llfi_index !98
  %44 = icmp eq i32 0, %43, !llfi_index !99
  br i1 %44, label %45, label %47, !llfi_index !100

; <label>:45                                      ; preds = %34
  %46 = load i8** %here, align 8, !llfi_index !101
  store i8* %46, i8** %1, !llfi_index !102
  br label %53, !llfi_index !103

; <label>:47                                      ; preds = %34
  %48 = load i64* %pos, align 8, !llfi_index !104
  %49 = add i64 %48, 1, !llfi_index !105
  store i64 %49, i64* %pos, align 8, !llfi_index !106
  br label %50, !llfi_index !107

; <label>:50                                      ; preds = %47
  br label %51, !llfi_index !108

; <label>:51                                      ; preds = %50, %31
  br label %7, !llfi_index !109

; <label>:52                                      ; preds = %7
  store i8* null, i8** %1, !llfi_index !110
  br label %53, !llfi_index !111

; <label>:53                                      ; preds = %52, %45
  %54 = load i8** %1, !llfi_index !112
  ret i8* %54, !llfi_index !113
}
...
; <label>:4                                       ; preds = %39, %0
  ...
  %7 = getelementptr inbounds [1333 x i8*]* %find_strings, i32 0, i64 %6, !llfi_index !128
  %8 = load i8** %7, align 8, !llfi_index !129
  %9 = icmp ne i8* %8, null, !llfi_index !130
  br i1 %9, label %10, label %42, !llfi_index !131

; <label>:10                                      ; preds = %4
  %11 = load i32* %i, align 4, !llfi_index !132
  %12 = sext i32 %11 to i64, !llfi_index !133
  %13 = getelementptr inbounds [1333 x i8*]* %find_strings, i32 0, i64 %12, !llfi_index !134
  %14 = load i8** %13, align 8, !llfi_index !135
  call void @init_search(i8* %14), !llfi_index !136
  %15 = load i32* %i, align 4, !llfi_index !137
  %16 = sext i32 %15 to i64, !llfi_index !138
  %17 = getelementptr inbounds [1332 x i8*]* %search_strings, i32 0, i64 %16, !llfi_index !139
  %18 = load i8** %17, align 8, !llfi_index !140
  %19 = call i8* @strsearch(i8* %18), !llfi_index !141
  store i8* %19, i8** %here, align 8, !llfi_index !142
  %20 = load i32* %i, align 4, !llfi_index !143
  %21 = sext i32 %20 to i64, !llfi_index !144
  %22 = getelementptr inbounds [1333 x i8*]* %find_strings, i32 0, i64 %21, !llfi_index !145
  %23 = load i8** %22, align 8, !llfi_index !146
  %24 = load i8** %here, align 8, !llfi_index !147
  %25 = icmp ne i8* %24, null, !llfi_index !148
  %26 = select i1 %25, i8* getelementptr inbounds ([1 x i8]* @.str212, i32 0, i32 0), i8* getelementptr inbounds ([5 x i8]* @.str213, i32 0, i32 0), !llfi_index !149
  %27 = load i32* %i, align 4, !llfi_index !150
  %28 = sext i32 %27 to i64, !llfi_index !151
  %29 = getelementptr inbounds [1332 x i8*]* %search_strings, i32 0, i64 %28, !llfi_index !152
  %30 = load i8** %29, align 8, !llfi_index !153
  %31 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([18 x i8]* @.str211, i32 0, i32 0), i8* %23, i8* %26, i8* %30), !llfi_index !154
  %32 = load i8** %here, align 8, !llfi_index !155
  %33 = icmp ne i8* %32, null, !llfi_index !156
  br i1 %33, label %34, label %37, !llfi_index !157

; <label>:34                                      ; preds = %10
  %35 = load i8** %here, align 8, !llfi_index !158
  %36 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([8 x i8]* @.str214, i32 0, i32 0), i8* %35), !llfi_index !159
  br label %37, !llfi_index !160

; <label>:37                                      ; preds = %34, %10
  %38 = call i32 @putchar(i32 10), !llfi_index !161
  br label %39, !llfi_index !162

; <label>:39                                      ; preds = %37
  %40 = load i32* %i, align 4, !llfi_index !163
  %41 = add nsw i32 %40, 1, !llfi_index !164
  store i32 %41, i32* %i, align 4, !llfi_index !165
